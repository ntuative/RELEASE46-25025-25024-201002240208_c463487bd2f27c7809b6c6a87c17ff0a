package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_476 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_696))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_696,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_95 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_696,"EOF"));
            }
         }
      }
      ...
      {
         if(var_476.parse(param1))
         {
            var_46.push(var_476);
            if(false)
            {
               var_134["null"] = var_476;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1208,var_476));
            var_476 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_134 != null && param1 < var_46.length)
         {
