package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_7:String = "client.init.volter.retry";
      
      public static const BAR_SPRITE:String = "barSprite";
      
      public static const const_9:String = "error_desc";
      
      public static const const_13:String = "client.init.volter.fail";
      ...
      public static const const_21:String = "debug";
      ...
      public static const const_10:String = "error_data";
      
      public static const const_11:String = "flash_version";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_11] = Capabilities.version;
            _loc6_[const_16] = 0;
            _loc6_[const_9] = param1;
            _loc6_[const_14] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_10] = String(param3.getStackTrace());
            }
            _loc6_[const_21] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
