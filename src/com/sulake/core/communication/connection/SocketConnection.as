package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1277:int = 10000;
      ...
      private var var_703:IEncryption;
      
      private var var_704:int;
      
      private var var_347:ByteArray;
      ...
      private var var_348:IConnectionStateListener;
      
      private var var_594:IProtocol;
      
      private var var_869:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_287 = param2;
         var_347 = new ByteArray();
         var_869 = new MessageClassManager();
         var_78 = new Socket();
         var_349 = new Timer(const_1277,1);
         var_349.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_349.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_704));
      ...
      {
         var_349.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_704));
      ...
      {
         var_349.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_704));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_869.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         ...
         if(var_348)
         {
            var_348.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_703 != null)
         {
            _loc3_ = var_703.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_348)
         {
            var_348.connectionInit(param1,param2);
         }
      ...
      {
         var_287.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_347.writeByte(var_78.readUnsignedByte());
         }
      }
      ...
      {
         var_869.registerMessages(param1);
      }
      ...
      {
         var_349.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_704));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_594.getMessages(var_347,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_348)
            {
               var_348.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_869.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_287.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_287.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_347,_loc2_);
            var_347 = _loc18_;
         }
      }
      ...
      {
         var_349.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_349.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_704));
         switch(param1.type)
         {
      ...
      {
         var_349.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_704));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_703 + "\n");
      }
   }
}
