package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1443:String = "_INCLUDE";
      
      public static const const_851:String = "_EXCLUDE";
      
      public static const const_1496:String = "_TEMP";
      
      private static const const_1075:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1076:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1371:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1372:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1098,var_1099);
         var_923 = new Dictionary();
         var_1372 = new Dictionary();
         ParamCodeTable.fillTables(var_923,var_1372);
         var_1371 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1076,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1372)
            {
               delete var_1372[_loc1_];
            }
            var_1371.dispose();
            var_1371 = null;
            _context = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_172)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_851) == -1)
                  {
