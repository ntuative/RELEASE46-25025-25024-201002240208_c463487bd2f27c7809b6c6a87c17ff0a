package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private var var_300:Rectangle;
      
      protected var var_614:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(param7 != null)
         {
            ...
            if(var_16)
            {
               _context.invalidate(this,var_5,WindowRedrawFlag.const_69);
            }
         }
      }
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         var _loc11_:Boolean = param1.getParamFlag(WindowParam.const_58);
         if(param2)
         {
            _loc3_ = 0;
         ...
         if(_loc9_)
         {
            if(_loc11_)
            {
               param1.setParamFlag(WindowParam.const_58,false);
            }
            if(param2)
            {
               _loc3_ = 0;
            ...
            if(_loc11_)
            {
               param1.setParamFlag(WindowParam.const_58,true);
            }
         }
      }
      ...
      public static function expandToAccommodateChild(param1:WindowController, param2:IWindow) : void
      {
         ...
         if(_loc8_)
         {
            _loc9_ = param1.getParamFlag(WindowParam.const_58);
            param1.setParamFlag(WindowParam.const_58,false);
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_127,WindowParam.const_139);
         var _loc2_:* = !testParamFlag(WindowParam.const_124,WindowParam.const_130);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_236)
               {
                  _loc3_.width += _loc4_;
               }
               ...
               else if(_loc5_ == WindowParam.const_172)
               {
      ...
      {
         var_744 = param1;
         var_613 = !!var_744 ? uint(var_613 | var_1373) : uint(var_613 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2018 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_862:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1366:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1265:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_459:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_470:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_350:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_702:
               _loc2_ = "null";
               break;
      ...
      {
         if(getStateFlag(WindowState.const_82))
         {
            return true;
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_577,var_5);
            var_16.visible = var_334;
         }
         return var_16;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_808,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var_403 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_965);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_309,this,param1));
         return param1;
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_613 = !!var_744 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_69);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_619))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_871;
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_223:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_172,WindowParam.const_139))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_161,WindowParam.const_130))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        ...
                        var_15 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_248,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_436:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_381);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_936,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_227,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_281:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_702,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_188,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_470:
               ...
               case WindowNotifyEvent.const_350:
                  if(!(var_15 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_381);
                     }
                  }
                  else if(var_15 & 0)
                  {
               ...
               case WindowNotifyEvent.const_188:
                  ...
                  break;
               case WindowNotifyEvent.const_483:
                  var_6.getRegionProperties(null,var_300);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_309:
                  if(testParamFlag(WindowParam.const_58))
                  {
      ...
      {
         return var_614 != null ? var_614 : (var_6 != null ? var_6.procedure : nullEventProc);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_593,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1000,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_33 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_470,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_351)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_356)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_15 & 0);
            if(_loc7_ == WindowParam.const_447)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_399)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_903,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_636,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_436,this,null));
            }
            if(_loc6_)
            {
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1202,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,true);
         _loc1_.type = WindowNotifyEvent.const_1309;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_161 && var_746 > 0)
         {
            if(!testParamFlag(WindowParam.const_29))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1494,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1494,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1342,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,false);
         _loc1_.type = WindowNotifyEvent.const_1346;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_300 = var_6.rectangle.clone();
               var_54.x = var_5.x;
               var_54.y = var_5.y;
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_361,this,var_6));
            }
            else
            {
               var_300.x = 0;
               ...
               var_300.width = 0;
               var_300.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_852,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_15 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_350,this,null));
         }
      }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = getParamFlag(WindowParam.const_58);
         for each(_loc1_ in _children)
         {
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               setParamFlag(WindowParam.const_58,false);
            }
            ...
            if(_loc8_)
            {
               setParamFlag(WindowParam.const_58,true);
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_15,_context,var_5,null,var_614,properties,var_612.concat(),_id) as WindowController;
         _loc2_.var_746 = var_746;
         _loc2_.var_161 = var_161;
         _loc2_._debug = _debug;
         _loc2_.var_300 = var_300.clone();
         ...
         _loc2_.var_613 = var_613;
         _loc2_.var_1373 = var_1373;
         _loc2_.var_1100 = var_1100;
         _loc2_.var_334 = var_334;
         _loc2_.var_403 = var_403;
         _loc2_.var_15 = var_15;
         _loc2_.var_33 = var_33;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_315;
         _loc2_.background = var_744;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_515;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_413;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_33 == WindowState.const_405)
         {
            return true;
         }
         var_33 = WindowState.const_405;
