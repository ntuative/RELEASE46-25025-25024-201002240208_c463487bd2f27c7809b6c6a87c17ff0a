package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1078:String = "decrement";
      
      private static const const_755:String = "slider_track";
      ...
      protected var var_743:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_161 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_443;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_491:
               if(param2.type == WindowNotifyEvent.const_227)
               {
                  if(!var_573)
                  {
                     if(_horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_361)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_755) as WindowController;
      }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_828 != null)
         {
            ...
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_828) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_47)
         {
            ...
            else if(param2.name == ScrollbarController.const_1078)
            {
               if(var_21)
               {
                  var_573 = true;
            ...
            else if(param2.name == ScrollbarController.const_755)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_844)
         {
