package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_335:IScrollbarWindow;
      
      private var var_1455:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_64))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_335)
         {
            var_335 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_335)
            {
               var_335.addEventListener(WindowEvent.const_246,scrollBarEventProc);
               var_335.addEventListener(WindowEvent.const_194,scrollBarEventProc);
            }
         }
         return var_335;
      }
      ...
      override public function dispose() : void
      {
         if(var_335)
         {
            var_335.removeEventListener(WindowEvent.const_246,scrollBarEventProc);
            var_335.removeEventListener(WindowEvent.const_194,scrollBarEventProc);
            var_335 = null;
         }
         if(var_820)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_194)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_820)
         {
            var_820 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_820;
      }
      ...
      {
         _itemList.method_6(param1,param2);
      }
   }
}
