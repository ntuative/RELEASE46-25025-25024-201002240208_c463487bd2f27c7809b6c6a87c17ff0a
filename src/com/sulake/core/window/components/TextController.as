package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_610 * maxScrollH,var_359 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_741)
         {
            context.removeLocalizationListener(var_315,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      {
         var_610 = param1;
         _field.scrollH = var_610 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_315 = param1;
         if(var_315.charAt(0) == "$" && var_315.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_315.slice(2,var_315.indexOf("}")),this);
            var_741 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1011,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_573,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_573,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_67.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_67.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_67.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_67.bottom,PropertyStruct.const_61,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_573,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_610 = var_610;
         _loc1_.var_359 = var_359;
