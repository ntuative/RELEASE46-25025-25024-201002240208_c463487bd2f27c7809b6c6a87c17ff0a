package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_931:ITabSelectorWindow;
      
      private var var_751:Boolean = false;
      
      protected var var_1590:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1590 == null)
         {
            var_1590 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1590;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_931 == null)
         {
            var_931 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_931 != null)
            {
               var_931.procedure = selectorEventProc;
            }
         }
         return var_931;
      }
      ...
      {
         return !!var_751 ? selector.iterator : null;
      }
