package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2269:uint = 0;
      
      protected var var_927:String = "";
      
      protected var var_435:Array;
      
      protected var var_928:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_435 = new Array();
         var_435[0] = MouseCursorType.const_322;
         var_435[1] = MouseCursorType.const_36;
         var_435[2] = MouseCursorType.const_322;
         var_435[3] = MouseCursorType.const_322;
         var_435[4] = MouseCursorType.const_36;
         var_435[5] = MouseCursorType.const_36;
         var_435[6] = MouseCursorType.const_322;
         if(var_318 == null)
         {
            var_318 = new Array();
            var_318[0] = WindowState.const_86;
            var_318[1] = WindowState.const_71;
            var_318[2] = WindowState.const_76;
            var_318[3] = WindowState.const_59;
            var_318[4] = WindowState.const_44;
            var_318[5] = WindowState.const_85;
            var_318[6] = WindowState.const_64;
         }
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_1011,param1.toolTipDelay != const_1389));
         return param2;
      }
      ...
      {
         var_927 = param1 == null ? const_739 : param1;
      }
