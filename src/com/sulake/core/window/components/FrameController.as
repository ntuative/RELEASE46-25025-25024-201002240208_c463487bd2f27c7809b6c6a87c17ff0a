package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_772:String = "margin_top";
      
      private static const const_1089:String = "_HEADER";
      
      private static const const_770:String = "margin_right";
      
      private static const const_1091:String = "_SCALER";
      
      private static const TITLE_ELEMENT_TAG:String = "_TITLE";
      
      private static const const_1090:String = "_CONTENT";
      
      private static const const_769:String = "margin_left";
      
      private static const const_771:String = "margin_bottom";
      ...
      private var var_1265:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_769,_loc3_.left,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_772,_loc3_.top,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_770,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_771,0 - _loc3_.bottom,PropertyStruct.const_61,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_189);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_190);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_189,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_189,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1265 == null)
         {
            var_1265 = findChildByTag(const_1089) as IHeaderWindow;
            if(!var_1265)
            {
      ...
      {
         return findChildByTag(const_1091) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_259,false);
         }
      ...
      {
         return content != null && var_1367 ? content.iterator : new Iterator(this);
      }
