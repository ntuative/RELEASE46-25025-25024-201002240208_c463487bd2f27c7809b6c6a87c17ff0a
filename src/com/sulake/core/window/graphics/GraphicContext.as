package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_786:uint = 256;
      
      protected static var var_617:uint = 0;
      
      protected static var var_365:uint = 0;
      
      public static const const_877:uint = 2;
      
      public static const const_1556:uint = 128;
      
      public static const const_1423:uint = 64;
      
      public static const const_675:uint = 4;
      
      public static const const_1245:uint = 0;
      
      public static const const_1249:uint = 16;
      
      public static const const_577:uint = 1;
      
      public static const const_1169:uint = 8;
      ...
      protected var var_1585:Boolean;
      
      protected var var_159:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_877:
               ...
               break;
            case GraphicContext.const_1169:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1249:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_675:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_786:
               break;
            case GraphicContext.const_1245:
               break;
            default:
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_159 = new Sprite();
            var_159.name = this.name + " - Child Container";
            var_159.mouseEnabled = false;
            addChild(var_159);
         }
         return var_159;
      }
         ...
         if(var_611)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1585,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1585,16777215);
                  }
                  var_365 += bitmap.width * bitmap.height * 4;
               }
