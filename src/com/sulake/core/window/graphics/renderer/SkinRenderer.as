package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_312:Dictionary;
      ...
      {
         var _loc3_:ISkinLayout = var_431[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_312[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_431[_loc1_]).dispose();
            delete var_431[_loc1_];
         }
         var_431 = null;
         _layoutsByState = null;
         for(_loc1_ in var_312)
         {
            ISkinTemplate(var_312[_loc1_]).dispose();
            delete var_312[_loc1_];
         }
         var_312 = null;
         var_313 = null;
      }
