package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1128:uint = 8;
      ...
      private var var_2245:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_608 = new Dictionary();
         var_1578 = new Dictionary();
         var_2245 = new Dictionary();
         TypeCodeTable.fillTables(var_1578,var_2245);
         var_1356 = new Dictionary();
         var_2246 = new Dictionary();
         StateCodeTable.fillTables(var_1356,var_2246);
         ...
         {
            var_366 = new Array();
            var_366.push(WindowState.const_59);
            var_366.push(WindowState.const_64);
            var_366.push(WindowState.const_85);
            var_366.push(WindowState.const_44);
            var_366.push(WindowState.const_76);
            var_366.push(WindowState.const_71);
            var_366.push(WindowState.const_86);
            var_366.push(WindowState.const_82);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1356)
         {
            _loc3_.push(var_1356[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1578[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_608[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_608[param1] = new Array(SkinContainer.const_1128);
         }
         var_608[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_608[_loc1_]).dispose();
