   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_776)
            {
               Core.crash("Error catched in EventDispatcher; some event listener crashed!",var_1300.errorID,var_1300);
            }
            return _result == const_493;
         }
         return false;
      }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1104) : uint(const_493);
      }
