package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1026:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_585:uint = 0;
      
      public static const const_952:String = "AssetLibraryReady";
      
      public static const const_1185:String = "AssetLibraryUnloaded";
      
      public static const const_458:String = "AssetLibraryLoaded";
      
      public static const const_1304:String = "AssetLibraryLoadError";
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_410)
         {
            _loc4_ = AssetTypeDeclaration(var_410[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_342 = _loc2_.resource;
         if(var_481)
         {
            AssetLibrary.fetchLibraryContents(this,var_482,var_342);
         }
         var_299 = true;
         dispatchEvent(new Event(AssetLibrary.const_458));
         dispatchEvent(new Event(AssetLibrary.const_952));
         if(var_481)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1001,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_817,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_935,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_410.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_410[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1026.splice(var_1026.indexOf(this),1);
            --var_585;
            var_409 = null;
            var_692 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_341.length ? getAssetByName(var_341[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1304));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_410)
         {
            _loc3_ = AssetTypeDeclaration(var_410[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_692[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_342[param1]);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_341.splice(var_341.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_410[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_342 != null ? false : false;
      }
   }
}
