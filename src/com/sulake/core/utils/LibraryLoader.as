package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1384:int = 5;
      ...
      protected var var_314:URLRequest;
      
      protected var _debug:Boolean = false;
      
      protected var _name:String;
      
      protected var var_342:Class;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_342 = this.getDefinition(_name) as Class;
         if(var_342 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_314.url + "!");
            return;
         }
         try
         {
            xmlClass = var_342.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_921 > 0)
            {
               var_14.close();
               var_14.unload();
               addRequestCounterToUrlRequest(var_314,const_1384 - var_921);
               var_14.load(var_314,_context);
               --var_921;
               return true;
            }
