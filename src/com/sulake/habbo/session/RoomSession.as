package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_965:UserDataManager;
      ...
      {
         if(var_33 == RoomSessionEvent.const_307 && _connection != null)
         {
            var_33 = RoomSessionEvent.const_91;
            if(isPrivateRoom)
            {
      ...
      {
         return var_965 as IUserDataManager;
      }
