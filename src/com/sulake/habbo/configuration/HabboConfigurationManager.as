package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1142);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_972[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_751 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_164));
         if(var_1789)
         {
      ...
      {
         var _loc4_:String = var_972[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1788);
