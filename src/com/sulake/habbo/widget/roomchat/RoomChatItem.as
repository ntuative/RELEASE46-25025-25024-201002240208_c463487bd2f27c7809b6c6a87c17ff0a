package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_492:int = 6;
      
      private static const const_342:int = 10;
      
      private static const const_1080:Number = 18;
      
      private static const const_1406:Number = 10;
      
      private static const const_1407:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1009,var_1008,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1009,var_1008,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1223 = param1.chatType;
         var_1009 = param1.userId;
         var_832 = param1.userName;
         var_1008 = param1.userCategory;
         _message = param1.text;
         var_1224 = param1.userX;
         var_194 = param1.userImage;
         var_1010 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1223)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_95:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_231:
         ...
         if(var_194 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_401 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1010 != 0)
            {
               _loc30_ = uint(var_1010 >> 16 & 255);
               _loc31_ = uint(var_1010 >> 8 & 255);
               _loc32_ = uint(var_1010 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1223 == RoomWidgetChatUpdateEvent.const_231)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_832);
            }
            else if(var_1223 == RoomWidgetChatUpdateEvent.const_237)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_832);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_401;
            _loc20_.width = _loc20_.textWidth + const_492;
            _width += _loc20_.textWidth + const_492;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_342 + _loc20_.textWidth + const_492;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1009,var_1008,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1009,var_1008,_roomId,_roomCategory,param1);
      }
