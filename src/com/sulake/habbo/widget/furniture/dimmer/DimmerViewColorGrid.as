package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_1222:XML;
      
      private var var_303:IWindowContainer;
      
      private var var_400:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_400.destroyGridItems();
         var_303 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1222) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_831.width,var_831.height,true,0);
      ...
      {
         var _loc2_:int = var_400.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_400.numGridItems)
         {
            return;
         }
         select(var_400.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_831 = BitmapData(_loc3_.content);
