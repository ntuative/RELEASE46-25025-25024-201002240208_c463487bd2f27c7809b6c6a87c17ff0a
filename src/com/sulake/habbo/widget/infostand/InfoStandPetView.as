package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1618:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1616:String = "level";
      
      private var var_100:IItemListWindow;
      
      private const const_1620:String = "energy";
      
      private var var_1186:Map;
      
      private const const_1615:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1622:uint = 3355443;
      
      private var var_211:IBorderWindow;
      
      private const const_1621:int = 158;
      
      private const const_1623:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_254:PetCommandTool;
      
      private const const_1617:uint = 11184810;
      
      private const const_1619:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_211.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_211.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function openTrainView() : void
      {
         if(var_254 == null)
         {
            var_254 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1186.getValue(var_635) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_254.showWindow(true);
            var_254.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function method_2(param1:int, param2:int) : String
      {
         var _loc3_:String = "";
         if(param2 < 10)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         raceText = _widget.localizations.getKey(method_2(param1.type,param1.race));
         petRespect = param1.petRespect;
         ageText = param1.age;
         updateStateElement(const_1616,param1.level,param1.levelMax);
         updateStateElement(const_1619,param1.experience,param1.experienceMax);
         updateStateElement(const_1620,param1.energy,param1.energyMax);
         updateStateElement(const_1615,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_635 = param1.id;
         var_1186.remove(param1.id);
         var_1186.add(param1.id,param1);
         if(var_254 && var_254.isVisible() && param1.isOwnPet)
         {
            var_254.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_254.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_407,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1621,const_1623,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1617);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1622);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1618);
         return _loc5_;
      }
