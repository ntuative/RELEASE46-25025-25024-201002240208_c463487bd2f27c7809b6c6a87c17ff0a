package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1605:int = 1100;
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_604,param1);
      ...
      {
         var_947.remove(param1);
         var_947.add(param1,param2);
         if(param1 != var_635)
         {
            return;
         }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_319 == null)
         {
            ...
            var_319 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_319 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_319.x = 200;
            var_319.procedure = onInfoWindowProcedure;
         }
         else
         {
            var_319.visible = true;
         }
      }
      
      private function onButtonDisableTimeout(param1:TimerEvent) : void
      {
         var _loc2_:Array = var_947.getValue(var_635) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_382,var_635));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_618,var_635,var_1678 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_947.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
            requestEnabledCommands(var_635);
         }
         else
         {
      ...
      private function createCommandWindow() : void
      {
         ...
         var_40.setParamFlag(WindowParam.const_84,true);
         var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_42,onWindowDesktopResized);
