package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      {
         super();
         var_171 = new Timer(1000);
         var_171.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_171.stop();
            var_171.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_171 = null;
         }
         _container = null;
         if(_window != null)
