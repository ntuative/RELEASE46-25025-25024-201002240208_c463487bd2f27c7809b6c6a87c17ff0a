package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_633:String = "me_menu_settings_view";
      ...
      public static const const_1251:String = "me_menu_rooms_view";
      
      public static const const_1009:String = "me_menu_dance_moves_view";
      ...
      private var var_263:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_672,onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_556,onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_731,onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_521,onToolbarClicked);
         ...
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_349,onShowAvatarEditorClubPromo);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_827,onHideAvatarEditorClubPromo);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_209,onAvatarDeselected);
         param1.addEventListener(RoomWidgetHabboClubUpdateEvent.const_187,onHabboClubEvent);
         param1.addEventListener(RoomWidgetAvatarActionUpdateEvent.const_506,onAvatarActionEvent);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(var_28.window.name == const_633)
         {
      ...
      private function onCreditBalance(param1:RoomWidgetCreditBalanceUpdateEvent) : void
      {
         ...
         var_1466 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",var_1466.toString());
      }
      
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         var _loc2_:* = null;
         if(!(var_263 && var_28.window.name == const_263))
         {
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_672,onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_556,onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_731,onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_521,onToolbarClicked);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_323,onUpdate);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_209,onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_187,onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarActionUpdateEvent.const_506,onAvatarActionEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_652,onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_349,onShowAvatarEditorClubPromo);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_827,onHideAvatarEditorClubPromo);
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_368:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + var_263 + " view: " + var_28.window.name);
               if(var_263 != true || var_28.window.name != const_121)
               {
                  return;
               }
               (var_28 as MeMenuMainView).setIconAssets("clothes_icon",const_121,"clothes_highlighter_blue");
               break;
      ...
      {
         var _loc2_:* = var_1221 > 0;
         var_1221 = param1.daysLeft;
         var_1950 = param1.periodsLeft;
         var_1954 = param1.pastPeriods;
         var_1949 = param1.allowClubDances;
      ...
      private function onShowAvatarEditorClubPromo(param1:RoomWidgetAvatarEditorUpdateEvent) : void
      {
         ...
         if(var_28 != null && var_28.window.name == const_263)
         {
            if(param1.promoMode == RoomWidgetAvatarEditorUpdateEvent.const_792)
            {
               var_94 = new ClubPromoView(this,param1.promoImageUrl,ClubPromoView.const_1377);
            }
            else
            {
               var_94 = new ClubPromoView(this,param1.promoImageUrl,ClubPromoView.const_406);
            }
            _loc2_ = _mainContainer.getChildByName(var_28.window.name);
            if(_loc2_ != null)
            {
               var_94.window.x = _loc2_.width + const_758;
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("me_menu_main_container","",HabboWindowType.const_1135,HabboWindowStyle.const_836,HabboWindowParam.const_39,new Rectangle(0,0,170,260)) as IWindowContainer;
      ...
      {
         var _loc2_:RoomWidgetToolbarMessage = new RoomWidgetToolbarMessage(RoomWidgetToolbarMessage.const_663);
      ...
      public function updateSize() : void
      {
         if(var_28 != null)
         {
            var_1007.x = var_28.window.width + 10;
            var_1007.y = var_28.window.height;
            var_28.window.x = 5;
            var_28.window.y = 0;
            ...
            if(var_94 != null)
            {
               _mainContainer.width = var_94.window.x + var_94.window.width + const_758;
            }
         }
      }
