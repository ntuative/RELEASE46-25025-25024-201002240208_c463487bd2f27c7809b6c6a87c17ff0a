      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_1009);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_811));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_713);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_934));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_263);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_599));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_633);
               break;
            case "news":
               if(false && false)
               {
