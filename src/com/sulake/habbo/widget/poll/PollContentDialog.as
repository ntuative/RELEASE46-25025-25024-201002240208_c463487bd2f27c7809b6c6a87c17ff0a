package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_685[var_1013] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_297)
         {
            ...
            var_297 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_297.center();
            var_297.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1013;
         if(var_1013 < var_685.length)
         {
            _loc1_ = var_685[var_1013] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_685.length);
                  _loc2_.text = _loc6_;
               }
