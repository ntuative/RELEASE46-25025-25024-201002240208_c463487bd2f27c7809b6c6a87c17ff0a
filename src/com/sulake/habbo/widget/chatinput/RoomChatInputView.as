package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1418:int = 5;
      
      private static const const_492:int = 16;
      
      private static const const_1110:int = 20;
      
      private static const const_342:int = 10;
      
      private static const const_1109:int = 40;
      ...
      private var var_396:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_2158 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2156 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_716 = new Timer(1000,1);
         var_716.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_890 = new Timer(5000,1);
         var_890.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _window.addEventListener(WindowEvent.const_463,onWindowMoved);
         var_1320 = true;
         var_140 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2157 = _loc2_.width + const_492 + _loc6_.width + const_1110;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1109,_loc8_.width) + const_492);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_396);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_396);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_506);
