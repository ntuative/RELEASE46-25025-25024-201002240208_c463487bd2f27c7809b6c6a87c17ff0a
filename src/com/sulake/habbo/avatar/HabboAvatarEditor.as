package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_582:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_688.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1247)
         {
            ...
            var_478["null"] = new FigureData(this);
            var_478["null"] = new FigureData(this);
            _loc1_ = var_478["null"];
            _loc2_ = var_478["null"];
            ...
            var_13 = new Map();
            var_13.add(AvatarEditorCategory.const_892,new GenericModel(this));
            var_13.add(AvatarEditorCategory.const_46,new HeadModel(this));
            var_13.add(AvatarEditorCategory.const_333,new TorsoModel(this));
            var_13.add(AvatarEditorCategory.const_1153,new LegsModel(this));
            var_13.add(AvatarEditorCategory.const_879,new WardrobeModel(this));
            var_1247 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_582 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1023 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1023 >= _loc14_.clubLevel))
               {
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1238)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_1023 >= _loc5_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_13.getValue(AvatarEditorCategory.const_879);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_688.getPalette(param1);
      }
      ...
      {
         var_688 = var_540.getFigureData(AvatarType.const_93);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_540 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_227 == null)
            {
               var_227 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_892);
         if(var_582 != null)
         {
            var_582.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1023 = param3;
         var _loc4_:FigureData = var_478[param2];
         if(_loc4_ == null)
         {
            return;
         }
