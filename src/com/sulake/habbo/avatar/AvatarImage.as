package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1033:String = "Default";
      
      private static const const_1032:int = 125;
      ...
      private var var_437:IAvatarDataContainer;
      ...
      private var var_162:IActiveActionData;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_183 == null)
         {
            var_183 = AvatarScaleType.const_50;
         }
         ...
         if(param5 == AvatarType.PET)
         {
            ...
            _avatarSubType = var_937;
         }
         var_132 = new AvatarImageCache(var_69,this,_assets,var_183);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            param2 = AvatarDirectionAngle.const_647 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_647)
         {
            param2 -= NaN;
         }
         if(var_626 == AvatarType.PET && param1 == AvatarSetType.const_46)
         {
      ...
      private function sortActions() : void
      {
         ...
         {
            var_531 = var_69.getCanvasOffsets(_loc1_,var_183,var_91);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1117 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_437 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_717)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_389)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_367)
            {
               _isAnimating = true;
            }
         }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_69.getCanvas(var_183,var_162.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_69.getBodyParts(param1,var_162.definition,var_91);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_438);
            if(_loc10_ != null)
            {
               ...
               if(var_626 == AvatarType.PET)
               {
                  ...
                  _loc18_ = 32;
                  if(var_183 == AvatarScaleType.const_97)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_438);
                     _loc21_ = var_91;
                     _loc22_ = 1;
                     switch(var_91)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_69.getCanvas(var_183,var_162.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_69.getBodyParts(param1,var_162.definition,var_91);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_438);
            if(_loc8_ != null)
            {
               ...
               if(var_626 == AvatarType.PET)
               {
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_438);
                     _loc19_ = var_91;
                     _loc20_ = 1;
                     switch(var_91)
                     {
         ...
         if(var_437 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_437.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_162 = new ActiveActionData(AvatarAction.const_922);
         var_162.definition = var_69.getActionDefinition(const_1033);
         setActionToParts(var_162);
         getCache().resetBodyPartCache(var_162);
         return true;
      }
      
      public function updateAnimation(param1:Number) : void
      {
         var_438 = int(param1 % const_1032);
         var_285 = true;
      }
      ...
      {
         return var_69.getBodyPartData(param1.animation.id,var_438,param1.id);
      }
