package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_286.getValue(AvatarType.const_93) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
         _loc2_ = var_286.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
      ...
      {
         var_687 = param1;
         if(var_687 == RenderMode.const_1327)
         {
            init();
         }
      }
      ...
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         ...
         var _loc6_:AvatarStructure = var_286.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_286.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_286.getValue(AvatarType.const_93) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_17,param1,param2,AvatarType.const_93);
      }
