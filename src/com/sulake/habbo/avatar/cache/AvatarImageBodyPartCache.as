package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageBodyPartCache
   {
      ...
      private var var_653:IActiveActionData;
      ...
      public function method_4(param1:IActiveActionData = null) : AvatarImageActionCache
      {
         if(param1 == null)
         {
            param1 = var_653;
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         ...
         var _loc2_:AvatarImageActionCache = method_4(var_653);
         if(_loc2_ != null)
         {
