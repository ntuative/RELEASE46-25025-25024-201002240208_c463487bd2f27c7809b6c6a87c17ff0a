package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1404:int = 60000;
      ...
      private var var_911:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_69.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_607)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_385)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         var _loc13_:AvatarImageActionCache = _loc3_.method_4(_loc6_);
         if(_loc13_ == null)
         {
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_69.getParts(param1,(var_911 as AvatarImage).getFigure(),_loc6_,var_1213,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_69.getCanvas(var_183,var_1213);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1161[param1])
            {
            ...
            _loc10_ = var_183 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_183 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_845 || _loc32_ == AvatarAction.const_717) && (_loc6_ == AvatarBodyPartType.const_333 || _loc6_ == AvatarBodyPartType.const_1209 || _loc6_ == AvatarBodyPartType.const_1213) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_183 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
