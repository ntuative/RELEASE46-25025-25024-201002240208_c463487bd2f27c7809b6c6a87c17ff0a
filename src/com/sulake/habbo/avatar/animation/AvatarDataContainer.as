package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1505,var_1504,var_1506,_alphaMultiplier);
         var_1077 = generatePaletteMapForGrayscale(var_2217,var_2215);
      }
      
      public function get reds() : Array
      {
         return var_1077.getValue("reds") as Array;
      }
      ...
      {
         return var_1077.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1077.getValue("greens") as Array;
      }
      ...
      {
         return var_1077.getValue("alphas") as Array;
      }
