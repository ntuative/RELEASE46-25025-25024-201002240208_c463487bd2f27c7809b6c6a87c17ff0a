package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_621:IItemListWindow;
      
      private var var_529:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_749:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_621 = _window.findChildByName("mylooks") as IItemListWindow;
         var_529 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_749 = _window.findChildByName("selector") as IItemListWindow;
         var_1377 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  _model.controller.catalog.openCatalogPage(CatalogPageName.const_234,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _model.selectMyLook(var_621.getListItemIndex(param2.parent));
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_528)
         {
            var_749.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_528 = [];
         while(true)
         {
            ...
            var_749.addListItem(_loc1_.window);
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in _model.hotLooks)
         {
            ...
            {
               var_529.addListItem(_loc3_.view.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_621.removeListItemAt(0);
            }
            for each(_loc2_ in _model.myLooks)
            {
               var_621.addListItem(_loc2_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_749.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_750 * 8 + var_529.getListItemIndex(param2.parent);
