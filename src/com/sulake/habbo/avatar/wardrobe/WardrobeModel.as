package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1573:String = "hot_looks";
      
      public static const const_1535:String = "my_looks";
      ...
      private var var_747:Boolean = true;
      ...
      public function WardrobeModel(param1:HabboAvatarEditor, param2:String = "")
      {
         ...
         var_527["null"] = new Array();
         var_527["null"] = new Array();
         var_527["undefined.index"] = 0;
         var_527["undefined.index"] = 0;
         initMyLooks();
         requestHotLooks();
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_527[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
