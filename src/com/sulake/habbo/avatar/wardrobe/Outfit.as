package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1490 = var_10.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_97);
         var_1490.setDirection(AvatarSetType.const_37,int(FigureData.const_966));
         _image = var_1490.getImage(AvatarSetType.const_37);
         _view.udpate(_image);
      }
