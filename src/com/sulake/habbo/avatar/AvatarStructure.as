package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_371:PartSetsData;
      
      private var var_1625:PartOffsetData;
      
      private var var_757:AvatarActionManager;
      
      private var var_147:IAssetLibrary;
      
      private var var_2278:IAssetLibrary;
      
      private var var_1367:Boolean = false;
      
      private var var_1626:AvatarRenderManager;
      ...
      private var var_1387:AvatarStructureDownloadSet;
      
      private var var_627:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_371 = new PartSetsData();
         _animationData = new AnimationData();
         var_1387 = new AvatarStructureDownloadSet();
         var_627 = new AnimationManager();
         var_626 = param4;
         var_1625 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_757.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_757.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_757.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_627.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_371.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_371.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1361[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_757.getDefaultActionType();
         var _loc7_:Array = var_371.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_627.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_440.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_440.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_371.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_371.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_626 + " ready to go!");
         if(var_626 == AvatarType.const_93)
         {
            var_371.getPartDefinition("ri").appendToFigure = true;
            var_371.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_93:
               var_1387.add(new AvatarStructureDownload(var_147,_loc5_,var_440));
               break;
            case AvatarType.PET:
         }
         var_1387.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_627.getAnimation(param1);
      }
      ...
      {
         var_757 = new AvatarActionManager(var_147,var_626);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_147.hasAsset("dance" + _loc1_))
         {
            ...
            var_627.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      {
         return var_757.sortActions(param1);
      }
   }
}
