package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1725 = param2;
         var_321 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_118,onBadgeImageReady);
         ...
         var_198 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2006 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_198);
      ...
      public function dispose() : void
      {
         if(var_321 != null)
         {
            var_321.events.removeEventListener(BadgeImageReadyEvent.const_118,onBadgeImageReady);
            var_321 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_695,var_2006);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_695,var_695));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_695,var_695));
         _localizations.registerParameter(param1,"level",var_1725.toString());
         _localizations.registerParameter(param1,"name",var_321.userName);
         _localizations.registerParameter(param1,"realname",var_321.realName);
      }
   }
}
