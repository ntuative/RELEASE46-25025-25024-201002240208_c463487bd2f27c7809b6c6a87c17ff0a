package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_639:String = "InitConnection";
      ...
      private var var_331:HabboCommunicationDemo;
      ...
      {
         var_331.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_331.shockwaveClientUrl = var_110.shockwaveClientUrl;
         var_331.ssoTicket = var_110.ticket;
         var_110.removeEventListener(SSOTicket.const_325,onParsedTicketSuccess);
         var_110.removeEventListener(SSOTicket.const_245,onParsedTicketFailure);
         var_110 = null;
         dispatchEvent(new Event(const_639));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1396,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_331 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_331.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_474,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_331.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1396,"/");
         if(_loc5_ != null)
         {
            _loc5_.method_1 = true;
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_331.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_331.habboCommunication.habboWebLogin(name,password);
         var_110 = new SSOTicket(var_331.assets,_loc2_,_loc1_);
         var_110.addEventListener(SSOTicket.const_325,onParsedTicketSuccess);
         var_110.addEventListener(SSOTicket.const_245,onParsedTicketFailure);
      }
