package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_164:HabboHotelView;
      ...
      private var var_70:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_290:
               ...
               break;
            case DisconnectReasonEvent.const_863:
               _loc3_ = var_97.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_983:
               _loc3_ = var_97.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_981:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1689)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_640 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_640);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_155);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1139,var_1690));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1396,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_449.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_449.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1688);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1396,"/");
      ...
      {
         var_640 = var_97.getKey("sso.ticket",null);
         var_1139 = var_97.getKey("flash.client.url","");
         var_1690 = var_97.getKey("external.variables.txt","");
         if(var_164 == null)
         {
            var_164 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_640 != null)
         {
            var_70.mode = HabboConnectionType.const_477;
            var_70.initConnection(HabboConnectionType.const_247);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1393 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_70 = param2 as IHabboCommunicationManager;
            _loc3_ = var_70.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_70.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_70.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_70.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_70.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_70.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_70.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_70.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_70.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_70.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_70.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_70.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_70.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_70.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_529);
            _loc3_ = new InitCryptoMessageComposer(var_70.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1688 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_70.mode)
         {
            case HabboConnectionType.const_477:
               _loc6_ = "";
               ...
               var_954 = _loc4_;
               var_164.loadBannerImage(_loc7_ + "?token=" + var_954,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1144:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1187:
               var_956 = generateRandomHexString(30);
               var_449 = new DiffieHellman(new BigInteger(var_97.getKey("connection.development.prime"),16),new BigInteger(var_97.getKey("connection.development.generator"),16));
               var_449.init(var_956);
               _loc8_ = var_449.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_164.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_954);
         ...
         var _loc9_:IConnection = var_70.getHabboMainConnection(null);
         ...
         var_449 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_956 = generateRandomHexString(30);
            var_449.init(var_956);
            _loc12_ = var_449.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_221);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(var_97).events.addEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_100,onRoomSessionEnded);
      }
