package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_1600:int = 5;
      
      private const const_1601:int = 5;
      ...
      {
         var _loc2_:ITextWindow = var_47.buildXmlWindow("tutorial_name_suggestion_item") as ITextWindow;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            _offsetX = 0;
            var_756 += param1.height + const_1601;
            return fit(param1);
         }
         param1.offset(_offsetX,var_756);
         _offsetX += param1.width + const_1600;
         return true;
      }
