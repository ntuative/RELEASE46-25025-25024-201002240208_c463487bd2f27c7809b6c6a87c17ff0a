package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_732:FaqCategory;
      
      private var var_731:FaqCategory;
      ...
      {
         super();
         var_731 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_732 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_142 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_731.hasItem(param1))
         {
            var_731.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_732.hasItem(param1))
         {
            var_732.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
