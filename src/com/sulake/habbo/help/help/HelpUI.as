package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2161:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","25025-25024-201002240140");
         var_193 = param5;
         var_104 = new Map();
         var_104.add(HabboHelpViewEnum.const_1296,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_137,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_408,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_249,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_217,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_683,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_311,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_626,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_220,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_104.add(HabboHelpViewEnum.const_824,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_591,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_276 == HabboHelpViewEnum.const_137 || false)
         {
            return;
         }
         if(var_422 == null)
         {
            ...
            var_422 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_422 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_422 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_422 as IWindow);
      ...
      {
         return var_104.getValue(var_276);
      }
      ...
      {
         var_2160 = param1;
         var _loc2_:IHelpViewController = var_104.getValue(HabboHelpViewEnum.const_137) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_882:
               showUI(HabboHelpViewEnum.const_824);
               break;
            case CallForHelpResultEnum.const_825:
      ...
      {
         var _loc3_:* = null;
         if(var_276 == HabboHelpViewEnum.const_137)
         {
            return;
         }
         if(true)
         {
            ...
            var_604.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_604.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_422.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_604[1],var_604[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_604[0],var_604[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1558;
         _window.width = _loc1_.width + var_1557;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_193 != null)
            {
               var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_29.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_617));
      }
