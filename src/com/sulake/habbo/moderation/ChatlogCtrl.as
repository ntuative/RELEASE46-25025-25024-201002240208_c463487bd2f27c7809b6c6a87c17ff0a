package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1450:IMessageComposer;
      ...
      {
         var_838 = IWindowContainer(var_47.getXmlWindow("chatlog_roomheader"));
         var_837 = IWindowContainer(var_47.getXmlWindow("chatlog_chatline"));
         var_407 = new Timer(300,1);
         var_407.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_50 = IFrameWindow(var_47.getXmlWindow("chatlog_frame"));
         var_49 = IItemListWindow(var_50.findChildByName("chatline_list"));
         var_50.procedure = onWindow;
         var _loc1_:IWindow = var_50.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_47.connection.send(var_1450);
         var_47.messageHandler.addChatlogListener(this);
      }
      ...
      public function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         ...
         var_47.messageHandler.removeChatlogListener(this);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_838.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_50,var_47,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_42 || param2 != var_50)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_837.clone());
         _loc4_.color = var_1240[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_50,var_47,_loc6_,param2.chatterId);
         }
