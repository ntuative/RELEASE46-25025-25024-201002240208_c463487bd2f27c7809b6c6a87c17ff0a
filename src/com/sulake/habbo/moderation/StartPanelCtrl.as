package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1195 ? 0 : 1,_roomId),var_47,WindowTracker.const_714,_roomId),var_50,false,false,true);
      }
