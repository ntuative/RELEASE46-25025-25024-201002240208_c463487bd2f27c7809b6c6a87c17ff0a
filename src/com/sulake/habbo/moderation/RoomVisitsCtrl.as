package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2249.clone());
      ...
      {
         var_2249 = IWindowContainer(var_47.getXmlWindow("roomvisits_row"));
