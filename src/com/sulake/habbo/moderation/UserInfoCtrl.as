package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_742:int = 31536000;
      
      private static const const_744:int = 86400;
      
      private static const const_741:int = 3600;
      
      private static const const_743:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_743) + " mins ago";
         }
         if(param1 < 2 * const_744)
         {
            return Math.round(param1 / const_741) + " hours ago";
         }
         if(param1 < 2 * const_742)
         {
            return Math.round(param1 / const_744) + " days ago";
         }
         return Math.round(param1 / const_742) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_47,WindowTracker.const_840,_data.userId),_callerFrame,var_939,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_755.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_47.getXmlWindow("user_info"));
            var_755.addChild(_loc1_);
            var_47.disableButton(var_47.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_47.disableButton(var_47.initMsg.alertPermission,_loc1_,"message_but");
            var_47.disableButton(var_47.initMsg.alertPermission || var_47.initMsg.kickPermission || var_47.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new ModActionCtrl(var_47,_data.userId,_data.userName,var_1147),_callerFrame,var_939,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new RoomVisitsCtrl(var_47,_data.userId),_callerFrame,var_939,false,true);
      }
      ...
      {
         var_47.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_47.messageHandler.addUserInfoListener(this);
         var_47.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_47.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_47 = null;
         _data = null;
         var_755 = null;
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new SendMsgsCtrl(var_47,_data.userId,_data.userName,var_1147),_callerFrame,var_939,false,true);
      }
