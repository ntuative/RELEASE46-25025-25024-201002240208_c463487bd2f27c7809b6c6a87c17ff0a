package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1070:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.releaseBundle(var_118.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_426 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_1070 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_426.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_118.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1070.load(_loc4_,var_118.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_118.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_59,WindowTracker.const_909,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_59 != null && false && var_118 != null)
         {
            var_59.issueManager.removeHandler(var_118.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_118.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_118.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1340;
      }
   }
}
