package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1608:String = "my_issues";
      ...
      private var var_325:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_213 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_213.numTabItems)
            {
               _loc5_ = var_213.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_213.selector.getSelectableByName("open_issues");
         var_213.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_325.view.width = var_213.container.width;
         var_325.view.height = var_213.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1608:
               if(var_1411 == null)
               {
                  var_1411 = new MyIssuesView(issueManager,this,var_213.container);
               }
               return var_1411;
            case const_1609:
               if(var_1412 == null)
               {
                  var_1412 = new OpenIssuesView(issueManager,this,var_213.container);
               }
               return var_1412;
            case const_1610:
               if(var_1413 == null)
               {
                  var_1413 = new PickedIssuesView(issueManager,this,var_213.container);
               }
               return var_1413;
            default:
               return null;
