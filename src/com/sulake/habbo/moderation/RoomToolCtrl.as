package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_936:ICheckBoxWindow;
      ...
      private var var_623:ICheckBoxWindow;
      
      private var var_50:IFrameWindow;
      
      private var var_935:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_47,WindowTracker.const_714,_data.flatId),var_50,false,false,true);
      }
      ...
      private function setSendButtonState(param1:String) : void
      {
         ...
         if(_loc2_ && var_47.initMsg.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("MSG TEMPLATES: " + var_47.initMsg.roomMessageTemplates.length);
         param1.populate(var_47.initMsg.roomMessageTemplates);
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_47.messageHandler.removeRoomEnterListener(this);
         if(var_50 != null)
         {
            var_50.destroy();
            var_50 = null;
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = IWindowContainer(var_47.getXmlWindow("roomtool_roomdata"));
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_404);
         if(param1.flatId != var_404)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_404);
            return;
         }
         _data = param1;
         populate();
         var_47.messageHandler.removeRoomInfoListener(this);
         var_50.visible = true;
         var_47.messageHandler.addRoomEnterListener(this);
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.openHkPage("roomadmin.url","undefined");
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new UserInfoFrameCtrl(var_47,_data.ownerId),var_50,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_623.isSelected);
         var_47.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1148,_loc2_,var_380.text,"",""));
         if(false)
         {
            var_47.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_936.isSelected,var_935.isSelected,var_623.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_47.initMsg.roomMessageTemplates["null"];
         if(_loc3_ != null)
         {
            var_311 = false;
            var_380.text = _loc3_;
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1160);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1332);
      }
      ...
      public function populate() : void
      {
         ...
         var_623 = ICheckBoxWindow(var_50.findChildByName("kick_check"));
         var_936 = ICheckBoxWindow(var_50.findChildByName("lock_check"));
         var_935 = ICheckBoxWindow(var_50.findChildByName("changename_check"));
         ...
         var_47.disableButton(var_47.initMsg.bobbaFilterPermission,var_50,"bobba_filter_but");
         var_47.disableButton(var_47.initMsg.chatlogsPermission,var_50,"chatlog_but");
         if(!var_47.initMsg.roomKickPermission)
         {
            var_623.disable();
         }
      ...
      private function onBobbaFilter(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.openHkPage("wordfilter.url","");
      }
      
      public function show() : void
      {
         var_50 = IFrameWindow(var_47.getXmlWindow("roomtool_frame"));
         var_47.messageHandler.addRoomInfoListener(this);
         var_47.connection.send(new GetModeratorRoomInfoMessageComposer(var_404));
         Logger.log("BEGINNING TO SHOW: " + var_404);
      }
   }
}
