package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1151:int = 6;
      
      public static const const_714:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1360:int = 7;
      
      public static const const_909:int = 3;
      
      public static const const_1340:int = 8;
      
      public static const const_840:int = 5;
      ...
      {
         var_1439 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1439[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1439[param1] = _loc2_;
         }
         return _loc2_;
      }
