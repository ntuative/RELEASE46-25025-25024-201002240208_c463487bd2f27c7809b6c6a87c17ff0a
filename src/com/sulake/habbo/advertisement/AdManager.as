package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_802:BitmapData = null;
      ...
      private var var_803:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_431,0,0,_loc4_,var_1429,var_803,var_802));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1843 = int(_config.getKey("interstitial.interval","30000"));
         var_1844 = int(_config.getKey("interstitial.show.time","5000"));
         var_1430 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1183 = _loc2_.imageUrl;
         var_1429 = _loc2_.clickUrl;
         if(var_1183 != "" && var_1429 != "")
         {
            _loc3_ = var_1183;
            ...
            _loc4_ = new URLRequest(var_1183);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1184 = _loc2_.imageUrl;
         var_1845 = _loc2_.clickUrl;
         var_661 = getTimer();
         if(var_1184 != "")
         {
            _loc3_ = var_1184;
            ...
            if(var_217 == null)
            {
               var_217 = new Timer(var_1844,1);
               var_217.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_217.reset();
            ...
            var_217.start();
            _loc4_ = new URLRequest(var_1184);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_397,0,0,param1.bitmapData,var_1845));
            var_661 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_802 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1430 > 0 && var_1428 >= var_1430)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_661;
         if(_loc1_ > var_1843)
         {
            ++var_1428;
      ...
      {
         var_287 = param2 as IHabboCommunicationManager;
         if(var_287 == null)
         {
            return;
         }
         _connection = var_287.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_439));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_803 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
