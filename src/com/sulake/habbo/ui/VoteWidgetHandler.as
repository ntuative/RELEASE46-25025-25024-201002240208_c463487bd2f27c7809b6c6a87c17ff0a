package com.sulake.habbo.ui
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_110:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_110,_loc2_.question,_loc2_.choices);
               break;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionVoteEvent.const_110);
