package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_319;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_701);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_503);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_516);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_115:
            ...
            case FriendRequestEvent.const_241:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_701:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_503:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_516:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_115);
         _loc1_.push(FriendRequestEvent.const_52);
         _loc1_.push(FriendRequestEvent.const_241);
         return _loc1_;
      }
