   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_150,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_118,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_135,onFigureUpdate);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_150,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_118,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_135,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_597);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_331);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_998);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_937);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_296)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_444)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_837)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_567);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_216)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_222)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_563);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1158;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_793;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_989;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1257);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_590.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_590.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_563);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_128];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_314);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_624);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_649);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_627);
         _loc1_.push(RoomWidgetUserActionMessage.const_433);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_618);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_128:
      ...
      public function dispose() : void
      {
         ...
         if(var_590 != null)
         {
            _loc1_ = var_590.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_590.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_433)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_314:
            ...
            case RoomWidgetUserActionMessage.const_527:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_912,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_256:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_624:
            ...
            case RoomWidgetUserActionMessage.const_382:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_649:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_627:
               ...
               break;
            case RoomWidgetUserActionMessage.const_433:
            ...
            case RoomWidgetPetCommandMessage.const_604:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_618:
