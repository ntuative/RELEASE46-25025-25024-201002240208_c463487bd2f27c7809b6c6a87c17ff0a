package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_74,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_585,RoomWidgetEcotronBoxOpenMessage.const_642,RoomWidgetEcotronBoxOpenedMessage.const_1382];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_271:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_74,0,_name,false,_loc3_.data);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_585:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_642:
