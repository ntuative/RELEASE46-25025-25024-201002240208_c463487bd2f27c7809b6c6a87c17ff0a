package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_540:IAvatarRenderManager = null;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_606,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_701 = _roomEngine.loadRoomResources(var_38.roomResources);
            if(false)
            {
               var_1277 = false;
               processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_90));
            }
         }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_38.roomId,var_38.roomCategory,var_271[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_241,processEvent);
         }
         _friendList = null;
         var_176.dispose();
         var_176 = null;
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_606,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_19 = null;
         var_858 = null;
         ...
         if(var_193 && false)
         {
            ...
            var_193.events.removeEventListener(HabboToolbarEvent.const_56,onHabboToolbarEvent);
         }
         var_193 = null;
         _localization = null;
         _config = null;
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_193 != null)
         {
            var_176.toolbarSize = var_193.size;
            var_176.toolbarOrientation = var_193.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_548:
               ...
               if(var_717 != null && _loc3_ == RoomObjectCategoryEnum.const_33)
               {
                  _loc7_ = var_38.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_444)
                  {
                     var_717.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_239:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_117:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_822,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_362:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_566);
            _loc13_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_655);
            _loc14_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_668);
            _loc15_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_543);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_254,canvasMouseHandler);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_294);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_461:
               ...
               var_175 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_297,WindowStyle.const_292,WindowParam.const_84) as IToolTipWindow;
               var_175.setParamFlag(WindowParam.const_48,false);
      ...
      {
         if(var_19 != null && var_38 != null && var_1278 && var_1277)
         {
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_241,processEvent);
         }
      }
