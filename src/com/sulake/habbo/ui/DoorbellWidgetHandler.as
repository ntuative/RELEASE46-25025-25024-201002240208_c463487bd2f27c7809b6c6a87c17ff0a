package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_98:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_508,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_125:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_125,_loc2_.userName));
               break;
      ...
      {
         return [RoomSessionDoorbellEvent.const_98,RoomSessionDoorbellEvent.const_125,RoomSessionDoorbellEvent.const_52];
      }
