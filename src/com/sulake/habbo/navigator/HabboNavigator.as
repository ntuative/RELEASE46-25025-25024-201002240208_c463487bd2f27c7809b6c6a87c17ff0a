package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2365:Dictionary;
      ...
      private var var_866:ISessionDataManager;
      
      private var var_865:RoomCreateViewCtrl;
      
      private var var_2070:RoomThumbnailRenderer;
      
      private var var_193:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_593:RoomInfoViewCtrl;
      ...
      private var var_1017:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_272 = new MainViewCtrl(this);
         var_593 = new RoomInfoViewCtrl(this);
         var_865 = new RoomCreateViewCtrl(this);
         var_2070 = new RoomThumbnailRenderer(this);
         var_1017 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_370 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_272.startSearch(Tabs.const_203,Tabs.const_289,param1);
         var_272.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_866)
         {
            var_866.release(new IIDSessionDataManager());
            var_866 = null;
         }
         if(_catalog)
         {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_174.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_193 != null)
         {
            var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_866 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_272.startSearch(Tabs.const_267,Tabs.const_204);
         var_370.getTab(Tabs.const_267).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_272.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
