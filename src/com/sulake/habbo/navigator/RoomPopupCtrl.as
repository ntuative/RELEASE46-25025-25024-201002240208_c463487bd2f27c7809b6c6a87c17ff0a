package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2070 = new RoomThumbnailRenderer(param1);
         var_846 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_177,var_116.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_846.refreshTags(_loc1_,var_116.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2070.refreshThumbnail(_loc1_,var_116.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_177,var_116);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_177,!true ? getEventCtg(var_116.categoryId) : getRoomCtg(var_116.categoryId));
         refreshRoomDesc(var_177,var_116);
         refreshExtraCont();
         refreshInfo(var_177,"trading_allowed",var_116.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_203,Tabs.const_212,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
