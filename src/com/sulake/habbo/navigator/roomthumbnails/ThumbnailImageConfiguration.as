package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_2037:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_2038 = this._navigator.getButtonImage(this.var_2035);
         }
      ...
      {
         var _loc1_:* = null;
         if(this.var_2037 == null)
         {
            _loc1_ = var_698.bitmap.rect;
            this.var_2037 = new Rectangle(var_1500,var_1500,_loc1_.width - 2 * var_1500,_loc1_.height - 2 * var_1500);
         }
         var_698.bitmap.fillRect(var_698.bitmap.rect,4281545523);
         var_698.bitmap.fillRect(this.var_2037,4284900966);
         copyTo(var_698.bitmap);
         if(_selected)
         {
            var_698.bitmap.copyPixels(var_2036,var_2036.rect,new Point(0,0),null,null,true);
         }
         var_698.invalidate();
      }
