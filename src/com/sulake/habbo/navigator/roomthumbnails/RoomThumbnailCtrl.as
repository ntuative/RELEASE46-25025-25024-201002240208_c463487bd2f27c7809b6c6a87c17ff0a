package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2123:IWindowContainer;
      ...
      private var var_2124:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1544,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1545,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1544 = IButtonWindow(find("top_tab"));
         var_1545 = IButtonWindow(find("obj_tab"));
         var_2124 = IWindowContainer(find("tile_grid"));
         var_2123 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1544,onTopTabButton);
         Util.setProcDirectly(var_1545,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2124;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_421)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2123;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_36,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
