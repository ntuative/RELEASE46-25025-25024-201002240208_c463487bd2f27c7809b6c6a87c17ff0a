package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_769:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_448 = new Timer(100);
         var_448.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_62 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_953 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_953.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1644 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_448)
         {
            var_448.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_448.reset();
            var_448 = null;
         }
      }
      ...
      {
         var_953.goBackToInitialState();
         var_953.input.textBackgroundColor = 4294967295;
         var_769 = var_62[0];
         if(var_1644 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_36,HabboWindowParam.const_67,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_953.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_769.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1134 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1134 = true;
            _loc3_.y = 1;
