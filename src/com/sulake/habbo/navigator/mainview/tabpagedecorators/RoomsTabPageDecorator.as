package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_243,Tabs.const_334);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_243,Tabs.const_674);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_243,Tabs.const_334,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_467 == null)
         {
            var_467 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_467.procedure = onChangeFilter;
