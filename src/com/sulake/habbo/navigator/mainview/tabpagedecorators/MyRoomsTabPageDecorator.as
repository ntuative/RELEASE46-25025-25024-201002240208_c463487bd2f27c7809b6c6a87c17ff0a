package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2377:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_709;
         }
         if(param1 == 2)
         {
            return Tabs.const_564;
         }
         if(param1 == 3)
         {
            return Tabs.const_587;
         }
         if(param1 == 4)
         {
            return Tabs.const_575;
         }
         return Tabs.const_204;
      }
      ...
      private function startSearch() : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_267,getSearchTypeForIndex(_loc1_));
      }
