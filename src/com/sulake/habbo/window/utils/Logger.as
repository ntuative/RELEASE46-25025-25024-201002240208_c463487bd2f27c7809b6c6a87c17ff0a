package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1523:ICoreWindowManager;
      ...
      {
         var_1523 = param2 as ICoreWindowManager;
         _window = var_1523.create("Logger::Output",HabboWindowType.const_474,WindowStyle.const_292,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_351 = var_1523.create("Logger::Output::Text",HabboWindowType.const_1,WindowStyle.const_292,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
