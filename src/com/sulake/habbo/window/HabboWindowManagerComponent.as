package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_2368:uint = 0;
      
      private var var_1289:ProfilerAgentTask;
      
      private var var_1287:ProfilerOutput;
      
      private var var_708:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1288 = Component(param1).events;
         var_413 = new Array();
      ...
      {
         return var_233[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_233[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_708 = new WindowRenderer(_loc4_);
         var_233 = new Array(const_346);
         var _loc6_:int = 0;
         while(_loc6_ < const_346)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_708,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_233[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_227 = var_233[const_1097];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_227.getMouseCursor().defineCustomCursorType(MouseCursorType.const_322,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_227.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1274,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_233[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_233.pop()).dispose();
            }
            var_233 = null;
            while(false)
            {
      ...
      {
         return var_233[param1].getDesktopWindow().getChildAt(var_227.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1287 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1287 = new ProfilerOutput(_loc3_,this,var_708);
               var_1286 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1286);
               var_1289 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1289);
               var_1042 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_919.length > 0)
         {
            var_1288.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_346 - 1;
            while(_loc2_ >= 0)
            {
               var_233[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1042)
         ...
         var_1288.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_346)
         {
            var_233[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1042)
         {
         ...
         if(WindowContext.var_919.length > 0)
         {
            WindowContext.var_919.flush();
         }
         if(WindowContext.var_1357.length > 0)
         {
            WindowContext.var_1357.flush();
         }
         var_1288.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_413[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_413[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1291,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1206,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1335,param2.name + ": " + param2.toString());
            }
         }
      }
   }
