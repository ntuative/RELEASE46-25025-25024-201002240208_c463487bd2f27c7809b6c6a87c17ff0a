package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1103:int = 20;
      
      private static const const_775:int = 100;
       
      
      private var var_2105:IScrollbarWindow;
      
      private var var_141:HabboMessenger;
      
      private var var_1535:IContainerButtonWindow;
      
      private var var_499:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_141 = param1;
         var_1535 = initButton("follow_friend",onFollowButtonClick,param2);
         var_49 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2105 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_141.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_141.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_549 || param3.type == Message.const_505 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_499.messages.length - const_775);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_499.messages.length)
         {
            refreshEntry(true,_loc1_,var_499.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc1_:Conversation = var_141.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(var_499 == null || _loc1_.id != var_499.id)
         {
            var_499 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_775 + const_1103)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_141.conversations.closeConversation();
         var_141.messengerView.refresh(true);
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_141.send(new FollowFriendMessageComposer(var_499.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_141.getButtonImage(param1);
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_505)
         {
            return 4292801535;
         }
         if(param1 == Message.const_901)
         {
            return 4294927974;
         }
         if(param1 == Message.const_653)
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_141.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_141.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1102;
         param1.invalidate();
      }
   }
}
