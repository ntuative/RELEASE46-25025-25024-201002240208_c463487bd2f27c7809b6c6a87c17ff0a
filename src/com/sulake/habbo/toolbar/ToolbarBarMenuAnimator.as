package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1053:Number = 90;
      
      private static const const_774:int = 50;
      
      private static const const_1052:Number = 25;
      ...
      private var var_1033:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1033 = param2;
         var_591 = new Timer(const_1052);
         var_591.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_484.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_484.splice(_loc3_,1);
            var_485.splice(_loc3_,1);
         }
         var_485.push(param1.name);
         var_484.push(param2);
         param1.addEventListener(WindowEvent.const_463,windowEventListener);
         param1.addEventListener(WindowEvent.const_194,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_484[var_485.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1033.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1033.getIconLoc(param1.iconId);
      ...
      {
         return var_485[var_484.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_592[_loc3_] = new Array();
            }
            if(var_592[_loc3_].indexOf(param1) < 0)
            {
               var_592[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_774 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_774 || param1.desktop.height - param1.y < const_1093;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_485.length)
         {
            if(var_485[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_592[_loc3_].length)
                  {
                     repositionWindow(var_592[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
