package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      {
         if(var_1281 == true || var_702 == 0)
         {
            if(false)
            {
               ++var_50;
               if(var_50 >= var_862.length)
               {
                  var_50 = 0;
                  ++var_702;
               }
      ...
      {
         return var_1281 == false && var_702 == 1 && var_1180 != var_33;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_50 <= var_863.length)
         {
            _loc2_ = var_863[var_50];
