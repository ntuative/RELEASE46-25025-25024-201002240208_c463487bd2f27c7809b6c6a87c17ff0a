package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1401:uint = 4.293848814E9;
      
      private var var_1178:int;
      
      private const const_1614:uint = 4.291613146E9;
      
      private var var_253:int = -1;
      ...
      private const const_1613:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_215.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_800;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_800,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1401) : uint(const_1400);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_709,var_80,var_985);
               dispose();
               break;
            case "cancel_button":
      ...
      {
         if(var_215 == null || true)
         {
            return;
         }
         var _loc1_:IItemListWindow = var_215.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_253) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_800);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_557[var_189]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_556[var_190]);
         _catalog.purchaseProductAsGift(var_709,var_80,var_985,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_145:
               ...
               if(var_1836 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_212)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1613)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1836 = _loc3_.text;
               break;
            case WindowMouseEvent.const_47:
               showSuggestions(false);
               if(var_1179)
               ...
               break;
            case WindowKeyboardEvent.const_557:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_253 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_253 + 1);
                     break;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_200:
                  ...
                  break;
               case ProductTypeEnum.const_441:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1425 = _loc1_.stuffTypes;
            var_557 = _loc1_.boxTypes;
            var_556 = _loc1_.ribbonTypes;
            var_800 = var_1425[0];
            var_189 = var_557[0];
            var_190 = var_556[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_215.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_253) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_253);
         }
         var_253 = param1;
         if(var_253 < 0)
         {
            var_253 = _loc2_.numListItems - 1;
         }
         if(var_253 >= _loc2_.numListItems)
         {
            var_253 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_253) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_215 == null)
         {
            var_215 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_462 == null)
         {
            var_462 = createWindow("suggestion_list_item") as IWindowContainer;
            var_462.procedure = suggestionsEventHandler;
         }
         if(var_215 == null || var_462 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_215.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_462.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
