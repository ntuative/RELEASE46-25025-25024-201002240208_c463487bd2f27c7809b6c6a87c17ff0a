package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_303 != null)
         {
            _loc2_ = var_303.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      override public function init() : void
      {
         ...
         var_1315 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_303 = null;
         for each(_loc1_ in var_1316)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1315) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_637.width,var_637.height,true,0);
               _loc3_.bitmap.copyPixels(var_637,var_637.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_768.width,var_768.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_638.width,var_638.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_638,var_638.rect,new Point(0,0),null,null,true);
