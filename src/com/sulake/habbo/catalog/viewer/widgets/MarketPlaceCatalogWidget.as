package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_872:MarketPlaceOfferData;
      
      private const const_1413:int = 1;
      
      private const const_1628:int = 40;
      
      private var var_498:IWindowContainer;
      
      private const const_1412:int = 2;
      ...
      private const const_1629:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_498)
         {
            ...
            var_498 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_498)
         {
            return;
         ...
         updateStatusDisplay(const_1412,_loc2_.length);
         if(!var_416)
         {
            var_416 = new Timer(25);
            var_416.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_871 = 0;
         populateList();
         var_416.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_565)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_498 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_498.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1413);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_417.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_416)
         {
            var_416.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_416 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_871 >= var_565.length)
            {
               return true;
            }
            addListItem(var_565.getWithIndex(var_871));
            ++var_871;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_872.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_417));
            _loc7_.selection = 0;
         }
      }
