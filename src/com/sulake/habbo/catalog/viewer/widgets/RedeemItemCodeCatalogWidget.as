package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1047 != null)
         {
            var_1047.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1048 != null)
         {
            var_1048.removeEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1047 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1047 != null)
         {
            var_1047.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1048 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1048 != null)
         {
            var_1048.addEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
