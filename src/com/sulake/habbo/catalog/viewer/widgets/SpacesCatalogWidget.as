package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1133:String = "default";
      
      private var var_1174:Array;
      
      private var var_984:BitmapData = null;
      
      private var var_214:int = 0;
      
      private var var_655:int = 0;
      
      private var var_1131:String = "1.1";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_174.floors.pattern)
                     {
                        var_798.push(String(_loc9_.@id));
                        var_1174.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_174.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_174.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_984 != null && var_983 != null)
         {
            setRoomImage(var_984,var_983);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_174.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_214 >= 0)
         ...
         for each(_loc1_ in var_174.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
         ...
         for each(_loc1_ in var_174.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_176:
               ...
               if(var_290 == _activeWallpaperPatterns.length)
               {
                  var_290 = 0;
               }
               var_214 = 0;
               var_654 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_174.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_654 = _loc8_.children().length();
                  }
               }
            ...
            case const_175:
               ...
               for each(_loc9_ in var_174.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_656 = _loc9_.children().length();
                  }
               }
            ...
            case const_177:
               ...
               var_655 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_174.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_655 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1133);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1173[var_291];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1131);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1133,var_1131,64,this,"window_romantic_wide");
