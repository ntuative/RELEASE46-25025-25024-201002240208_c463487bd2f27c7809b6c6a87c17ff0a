package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_381 >= var_288.length)
         {
            return "";
         }
         var petColor:IPetColor = var_288[var_381] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_552[var_1407] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_381 < 0 || var_381 > var_288.length)
         {
            var_381 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_565.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         var_784 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_288 = [];
         var_552 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_784);
               if(_loc11_)
               {
                  var_552 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_552.length)
         {
            _loc12_ = var_552[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(method_2(var_784,_loc12_.id),method_2(var_784,_loc12_.id)));
            _loc6_++;
         }
         var_565.add(var_784,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_999,onApproveNameResult);
         _loc5_ = var_565.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_565.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_381 >= 0 && var_381 < var_288.length)
         {
            _loc7_ = var_288[var_381] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_552[var_1407] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_784,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_310,AvatarAction.const_648);
