package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1200:IScrollbarWindow;
      
      protected var var_1375:XML;
      
      private var var_1201:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1310.text = "${" + _loc3_.name + "}";
            var_1311.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1310.text = "${" + _loc2_.localizationId + "}";
            var_1311.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_445:
                  _loc4_ = var_1201.clone();
                  if(var_564 != null)
                  {
                     var_564.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_564,var_1200,var_1375);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_200:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_310,AvatarAction.const_721);
                              _loc13_.appendAction(AvatarAction.const_650,_loc6_.productClassId);
      ...
      {
         var_1310 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1311 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1448 = new Point(var_84.x,var_84.y);
         var_564 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1200 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_564 == null)
         {
         ...
         var_1201 = _loc2_.content as BitmapData;
