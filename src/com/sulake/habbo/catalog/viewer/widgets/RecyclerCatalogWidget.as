      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_27:
               if(var_268 != null)
               {
                  var_268.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(var_268 == null)
               {
                  var_268 = new CatalogObjectMover();
                  var_268.mainContainer = window;
                  var_268.roomEngine = _loc3_;
               }
               var_268.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
