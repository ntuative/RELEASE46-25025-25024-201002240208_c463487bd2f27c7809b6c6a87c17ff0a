package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1003 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1003 != null)
         {
            var_1003.addEventListener(WindowKeyboardEvent.const_557,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1003.text));
      }
   }
}
