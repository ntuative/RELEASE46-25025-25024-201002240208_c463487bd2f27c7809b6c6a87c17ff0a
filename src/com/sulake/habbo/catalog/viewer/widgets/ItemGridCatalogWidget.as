   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_246,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.WINDOW_EVENT_DISABLE,deActivateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_194,deActivateScrollbar);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            var_171.stop();
            var_171.removeEventListener(TimerEvent.TIMER,populateItemGrid);
            var_171 = null;
         }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_859 >= 0 && var_859 < page.offers.length)
            {
               _loc4_ = page.offers[var_859];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++var_1514;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1514);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_127)
         {
            var_171 = new Timer(25);
            var_171.addEventListener(TimerEvent.TIMER,populateItemGrid);
            var_171.start();
         }
      }
