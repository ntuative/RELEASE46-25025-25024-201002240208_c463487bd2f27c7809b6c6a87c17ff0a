package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_740.length)
         {
            createLevelItem(var_740[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_565 = new Map();
         var_740 = recycler.getPrizeTable();
         if(var_740 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_740[0].prizes.length > 0)
         {
            select(var_740[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_2247) as IWindowContainer;
