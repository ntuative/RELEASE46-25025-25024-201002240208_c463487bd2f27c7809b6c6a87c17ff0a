package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1127:EventDispatcher;
      ...
      {
         return _localization.hasLinks(var_763);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1127;
            _loc2_.init();
         }
         var_1127.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1127.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_763);
      }
