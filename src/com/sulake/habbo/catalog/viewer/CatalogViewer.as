package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1536:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_709 != null)
         {
            _container.removeChild(var_709.window);
            var_709.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1536);
         var_709 = _loc5_;
      ...
      {
         return var_709.dispatchWidgetEvent(param1);
      }
