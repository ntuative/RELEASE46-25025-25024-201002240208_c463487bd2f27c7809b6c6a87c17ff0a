package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_183:Dictionary = new Dictionary();
      
      private static const const_768:Object = {"frontpage3":[7,8]};
      
      private static const const_1088:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_767:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      private static const const_1087:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_183["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_183["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_183["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_183["collectibles"] = ["ctlg_collectibles_link"];
         const_183["club1"] = ["ctlg_text_5"];
      }
      ...
      {
         if(param1 < var_589.length)
         {
            return var_589[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_589.length)
         {
            _loc2_ = String(var_589[param1]).replace("#","0x");
