package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1004 + var_1004 / -var_2336 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_821 - var_821 / var_392 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_392).toString().length - 1);
         var_392 = Math.ceil(var_392 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_392.toString();
         _loc3_.draw(_loc6_);
         var_1004 = param1 - _loc6_.textWidth - 2;
         var_821 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_821);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_821 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1004 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1004,(param2 - var_821) / 2));
         return _loc3_;
      }
