package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_763:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1481)
         {
            case RecyclerStatusMessageEvent.const_1344:
               var_266 = const_345;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_906:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1481 != RecyclerStatusMessageEvent.const_906;
      }
      
      private function get statusActive() : Boolean
      {
         return var_266 != const_763;
      }
      ...
      {
         return active && var_266 == const_345;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_855:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1331:
