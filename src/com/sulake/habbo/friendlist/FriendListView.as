package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1391:String = "noconvinfo";
      
      private static const const_1392:String = "messageinput";
      ...
      private var var_1115:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1115 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_900 = IWindowContainer(var_12.content.findChildByName("main_content"));
         var_278 = IWindowContainer(var_12.content.findChildByName("footer"));
         var_1115.prepare(var_900);
         var_12.procedure = onWindow;
         var_12.content.setParamFlag(HabboWindowParam.const_821,false);
         var_12.content.setParamFlag(HabboWindowParam.const_1271,true);
         var_12.header.setParamFlag(HabboWindowParam.const_560,false);
         var_12.header.setParamFlag(HabboWindowParam.const_956,true);
         var_12.content.setParamFlag(HabboWindowParam.const_560,false);
         var_12.content.setParamFlag(HabboWindowParam.const_956,true);
         var_12.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1114 = ITextWindow(var_12.findChildByName("info_text"));
         var_1114.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_278.y = Util.getLowestPoint(var_12.content);
         ...
         var_12.scaler.setParamFlag(HabboWindowParam.const_831,this._friendList.tabs.findSelectedTab() != null);
         var_12.scaler.setParamFlag(HabboWindowParam.const_560,false);
         var_12.scaler.setParamFlag(HabboWindowParam.const_821,false);
         var_12.scaler.x = 0 - var_12.scaler.width;
         var_12.scaler.y = 0 - var_12.scaler.height;
         var_1380 = var_12.height;
         var_1379 = var_12.width;
