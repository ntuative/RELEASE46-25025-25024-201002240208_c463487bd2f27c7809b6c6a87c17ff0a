package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1494:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_645 = param1.online;
         var_1243 = param1.followingAllowed && param1.online;
         var_530 = param1.figure;
         var_1241 = param1.motto;
         var_1244 = param1.lastAccess;
         var_1149 = param1.categoryId;
         var_1242 = param1.realName;
