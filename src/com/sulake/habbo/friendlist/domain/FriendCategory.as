package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_959:int = 0;
      
      public static const const_391:int = -1;
      
      public static const const_324:int = 100;
      ...
      {
         return Math.ceil(this.var_212.length / const_324);
      }
      ...
      {
         if(this.var_787 >= this.getPageCount())
         {
            this.var_787 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_212[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_212.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_787 + 1) * const_324,this.var_212.length);
      }
