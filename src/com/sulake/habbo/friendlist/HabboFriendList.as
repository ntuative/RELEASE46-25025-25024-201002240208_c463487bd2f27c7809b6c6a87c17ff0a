package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1555:OpenedToWebPopup;
      
      private var var_830:IAvatarRenderManager;
      ...
      private var var_1556:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_886:FriendRequests;
      
      private var var_1643:int;
      
      var var_13:FriendCategories;
      
      private var var_2155:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_885:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2155 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1556 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_886.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_886.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_370.findTab(FriendListTab.const_83).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_886 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_959,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_391,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_13.addFriend(new Friend(_loc4_));
         }
         var_370 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_505)
         {
            var_505 = new Timer(120000);
            var_505.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_505.start();
         }
         getBuddyRequests();
         registerListeners();
         var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_122,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_505.stop();
            var_505.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_505 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_141)
         {
            var_141.release(new IIDHabboMessenger());
            var_141 = null;
         }
         if(var_174)
         {
         ...
         if(var_830)
         {
            var_830.release(new IIDAvatarRenderManager());
            var_830 = null;
         }
         if(var_885)
         {
            var_885.release(new IIDHabboNotifications());
            var_885 = null;
         }
         if(var_193)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_141 = param2 as IHabboMessenger;
      ...
      {
         var _loc1_:String = var_174.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_370.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_282));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1556.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_886.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_193.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_370.findTab(FriendListTab.const_83);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_830.createAvatarImage(param1,AvatarScaleType.const_97);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_886.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_370.findTab(FriendListTab.const_83);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_830 = param2 as IAvatarRenderManager;
      ...
      {
         var_885 = param2 as IHabboNotifications;
      ...
      {
         return var_174.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1555 == null)
         {
            var_1555 = new OpenedToWebPopup(this);
         }
         var_1555.show(x,y);
      }
