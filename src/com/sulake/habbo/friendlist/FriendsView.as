package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_603:String = "bg";
       
      
      private var var_2146:IContainerButtonWindow;
      
      private var var_2148:IContainerButtonWindow;
      
      private var var_2149:IContainerButtonWindow;
      
      private var var_2147:IContainerButtonWindow;
      
      private var var_339:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_339 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_2148 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2149 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2146 = initButton("room_invite",onInviteButtonClick,param1);
         var_2147 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_603);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_339.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_339.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_27)
         {
            this.var_339.closePopup();
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2148,isEnableMinimailButton(_loc1_));
         setEnabled(var_2149,isEnableHomeButton(_loc1_));
         setEnabled(var_2146,isEnableInviteButton(_loc1_));
         setEnabled(var_2147,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_603);
