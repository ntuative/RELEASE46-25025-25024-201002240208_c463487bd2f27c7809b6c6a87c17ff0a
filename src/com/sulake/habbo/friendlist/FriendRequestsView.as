package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1399:String = "no_reqs_info";
      ...
      private var var_1420:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_326 && _loc4_.state != FriendRequest.const_312)
            {
      ...
      {
         var_1419 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1420 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1420.procedure = onDismissAllButtonClick;
         var_1419.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_326 && _loc4_.state != FriendRequest.const_312)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_241,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_992)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1419,_loc1_);
         setEnabled(var_1420,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_326;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_241,param1));
         }
      }
   }
}
