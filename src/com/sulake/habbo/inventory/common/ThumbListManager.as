package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_958:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_543 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_543.width;
         var_92 = var_543.height;
         var_957 = param5;
         var_771 = param6;
         var_210 = Math.floor(var_957 / _thumbWidth);
         var_18 = new BitmapData(var_957,var_771);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_450 - 1)
         {
            ...
            var_18.fillRect(new Rectangle(0,0 - var_92,var_18.width,var_92),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_18.width,0 - var_92);
               _loc2_ = new Rectangle(0,0,var_18.width,0 - var_92);
               _loc11_.copyPixels(var_18,_loc2_,new Point(0,0),null,null,true);
               var_18 = _loc11_;
               --var_450;
            }
         }
         if(var_18.height < var_771)
         {
            _loc12_ = new BitmapData(var_18.width,var_771);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_543.width,var_543.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_543.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_543,var_543.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_958 != null)
         {
            _loc1_ = var_958.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_450 = resolveRowCountFromList();
         if(var_450 == 0)
         {
            var_18 = new BitmapData(var_957,var_771);
            return;
         }
         var_18 = new BitmapData(Math.max(var_210 * _thumbWidth,var_957),Math.max(var_450 * var_92,var_771),true,16777215);
         var_18.fillRect(var_18.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_450)
         {
            _loc4_ = 0;
            while(_loc4_ < var_210)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_18.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_92),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_210 && var_18.height < _loc3_.y * var_92)
         {
            _loc2_ = new BitmapData(var_18.width,var_18.height + var_92);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_210 - 1),var_92);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_210 - 1),0,_thumbWidth,var_18.height);
         _loc2_.copyPixels(var_18,_loc4_,new Point(0,var_92),null,null,true);
         _loc4_ = new Rectangle(0,var_92,_thumbWidth * (var_210 - 1),0 - var_92);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,var_92),null,null,true);
         var_18 = _loc2_;
      }
