package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            var_19.events.removeEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_373,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_100:
               var_764 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_373:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_571));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_44.getValue(InventoryCategory.const_70));
      }
      ...
      {
         var_146.clubPeriods = param1;
         var_146.clubDays = param2;
         var_146.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_157));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_885));
      }
      ...
      {
         return AchievementsModel(var_44.getValue(InventoryCategory.const_285));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_251:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_765.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_765.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_44.getValue(InventorySubCategory.const_251));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_321 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_765.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_146.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_44.getValue(InventoryCategory.const_372) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_945 = new IncomingMessages(this);
      ...
      {
         return var_146.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_146.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_44.getValue(InventoryCategory.const_262));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionEvent.const_100,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_373,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_372,_loc3_);
         ...
         var_44.add(InventoryCategory.const_70,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_321);
         var_44.add(InventoryCategory.const_262,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_44.add(InventoryCategory.const_571,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_321);
         var_44.add(InventoryCategory.const_285,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_44.add(InventorySubCategory.const_251,_loc8_);
         ...
         var_44.add(InventoryCategory.const_157,_loc10_);
