package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2267:BitmapData;
      
      protected var var_922:Boolean;
      
      protected var var_2256:Boolean;
      
      protected var var_1822:int;
      ...
      private const const_1602:int = 8947848;
      ...
      private const const_1403:Number = 0.2;
      
      protected var var_1368:Boolean;
      
      private const const_1402:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_662)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1370);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1403;
               _loc1_.blend = const_1403;
            }
            else
            {
               _window.blend = const_1402;
               _loc1_.blend = const_1402;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1368 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2267;
               _loc5_.visible = true;
            }
            else
            {
