package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_321 = param6;
         var_321.events.addEventListener(BadgeImageReadyEvent.const_118,onBadgeImageReady);
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(var_785[_loc2_] == param1)
            {
               var_785.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_248.length)
         {
            _loc2_ = var_248[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_248.length)
               {
                  if((var_248[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_248[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_262 && false)
         {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_321.getBadgeImage(param1);
            var_248.push(_loc8_);
            if(param2)
            {
