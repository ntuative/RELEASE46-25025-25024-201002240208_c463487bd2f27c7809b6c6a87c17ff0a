package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_764:uint = 4284532064;
      ...
      private var var_1486:IWindowContainer;
      
      private var var_171:Timer;
      
      private var var_339:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_339 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_820)
            {
            ...
            var_339.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_429);
            var_339.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_171)
            {
               var_171.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_171.stop();
               var_171 = null;
            }
            if(var_339 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1486 == null)
         {
            var_1486 = createMinimizedWindow();
         }
         if(!var_1987)
         {
            return var_64;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_171 == null)
         {
            var_171 = new Timer(1000,3);
            var_171.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_171.reset();
         var_171.repeatCount = 3;
         var_171.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_764) : uint(const_765);
            }
