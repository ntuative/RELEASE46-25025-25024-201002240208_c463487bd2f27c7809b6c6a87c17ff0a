package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_369:uint = 4;
      ...
      public static const const_1293:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_472 = false;
         var_679 = false;
         var_45.updateItemList(var_680);
         var_45.updateItemList(var_1217);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_45.alertPopup(TradingView.const_796);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_680)
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_680)
            {
               var_45.alertPopup(TradingView.const_1017);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_33 + " NEW STATE: " + param1 + " OWN: " + var_472 + " OTHER: " + var_679);
         ...
         {
            case const_169:
               if(param1 == const_167 || param1 == const_207)
               {
                  var_33 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_45.setMinimized(param1 != InventoryCategory.const_70);
         var_8.updateSubView();
      }
      ...
      public function close() : void
      {
         if(var_575)
         {
            if(var_33 != const_169 && var_33 != const_207)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_169;
            var_8.toggleInventorySubPage(InventorySubCategory.const_839);
            var_575 = false;
         }
         var_45.setMinimized(false);
      }
