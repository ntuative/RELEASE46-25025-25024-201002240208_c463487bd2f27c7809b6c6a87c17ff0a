package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_773:uint = 11;
      ...
      private var var_412:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1032:int = -1;
      
      private var var_1268:LagWarningLogger = null;
      
      private var var_853:IHabboWindowManager;
      ...
      private var var_173:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1268 = new LagWarningLogger();
         var_1267 = new Array(const_773);
         var _loc4_:int = 0;
         while(_loc4_ < const_773)
         {
            var_1267[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1367,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1228,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_525,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_789,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_529:
               trackLoginStep(HabboLoginTrackingStep.const_1307,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_213:
               trackLoginStep(HabboLoginTrackingStep.const_213);
               break;
            case HabboCommunicationEvent.const_173:
               trackLoginStep(HabboLoginTrackingStep.const_173);
               break;
            case HabboCommunicationEvent.const_155:
               setErrorContextFlag(2,0);
               trackLoginStep(HabboLoginTrackingStep.const_155);
               break;
            case HabboCommunicationEvent.const_221:
               setErrorContextFlag(3,0);
               trackLoginStep(HabboLoginTrackingStep.const_221);
               if(var_232 != null)
               {
                  var_232.init();
               }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_282:
      ...
      {
         var_174 = IHabboConfigurationManager(param2);
         if(var_174)
         {
            Component(var_174).events.addEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
            if(var_232 != null)
            {
               var_232.configuration = var_174;
            }
            if(var_231 != null)
            {
               var_231.configuration = var_174;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_431,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2033)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1195);
            var_2033 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_789,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_525,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_529,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_213,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_155,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_173,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_221,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_687,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_63,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_454,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_469:
               var_1268.registerWarning(LagWarningLogger.const_874);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_853)
            {
               var_853.release(new IIDHabboWindowManager());
               var_853 = null;
            }
            if(_adManager)
            {
            ...
            if(var_173)
            {
               if(true)
               {
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.const_282,onFriendlistTrackingEvent);
               }
               var_173.release(new IIDHabboFriendList());
               var_173 = null;
            }
            if(var_412)
            {
               if(true)
               {
                  var_412.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_412.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_412.release(new IIDHabboHelp());
               var_412 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_469,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_174)
         {
            Component(var_174).events.removeEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
         }
      }
      ...
      {
         var_412 = param2 as IHabboHelp;
         var_412.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_412.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_794);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_794,onCoreRunning);
         }
      }
      ...
      {
         var_853 = IHabboWindowManager(param2);
         if(var_853)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1032 > -1 && _loc2_ < var_1032)
         {
            ++var_1498;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1498);
         }
         if(var_1032 > -1 && _loc2_ - var_1032 > 15000)
         {
            ++var_1499;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1499);
         }
         var_1032 = _loc2_;
         if(var_231 != null)
         {
         ...
         if(var_1268 != null)
         {
            var_1268.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_174 != null && Boolean(var_174.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_469,onLagWarningEvent);
      ...
      {
         var_173 = param2 as IHabboFriendList;
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.const_282,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_174)
            {
               if(var_174.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_174.getKey("client.fatal.error.url");
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_687)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1236);
         }
         else if(param1.type == HabboHotelViewEvent.const_454)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1188);
         }
         else if(param1.type == HabboHotelViewEvent.const_63)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1218);
         }
      }
   }
}
