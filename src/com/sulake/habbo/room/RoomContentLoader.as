package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_1040:String = const_337;
      ...
      public static const const_656:String = "RCL_LOADER_READY";
      ...
      private var var_959:IEventDispatcher = null;
      
      private var var_1140:Map = null;
      
      private var _furniRevisions:Map = null;
      
      private var _wallItemTypes:Map = null;
      
      private var var_544:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_452 = [];
         var_451 = [];
         var_1694 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1695 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_376 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_31:
                     if(var_452.indexOf(_loc4_) == -1)
                     {
                        var_452.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_28:
                     if(var_451.indexOf(_loc4_) == -1)
                     {
                        var_451.push(_loc4_);
                     }
                     break;
      ...
      {
         if(var_165 != null && var_165.hasWorldType(const_274 + param1))
         {
            return var_165.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_453.add(_loc10_,_loc11_);
                              if(var_452.indexOf(_loc14_) < 0)
                              {
                                 var_452.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_451.indexOf(_loc14_) < 0)
                              {
                                 var_451.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_376 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_376.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_376.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_545.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_376.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_337,const_486,ROOM_CONTENT,const_745,const_746];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_31 || _loc2_ == RoomObjectCategoryEnum.const_28)
         {
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1694.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_154 && _loc5_ != RoomObjectLogicEnum.const_103)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_453.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_452.indexOf(param1) >= 0)
         {
            return const_337;
         }
         if(var_451.indexOf(param1) >= 0)
         {
            return const_486;
         }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_544.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_375 != null)
         {
            _loc2_ = var_375.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1323);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_370,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_1699)
         {
            ...
            if(var_959 != null)
            {
               var_959.dispatchEvent(new Event(const_656));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_165 != null)
         {
            return var_165.getWorldHeightScale(const_274 + param1);
         }
         return 1;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               if(_loc3_ == RoomObjectCategoryEnum.const_31 || _loc3_ == RoomObjectCategoryEnum.const_28)
               {
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_959 = param1;
            var_1693 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1698 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1696 = param2.getKey("public.room.dynamic.download.url","");
            var_1697 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_33 = const_747;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_375 != null)
         {
            var_375.remove(param1);
            var_375.add(param1,param2);
         }
         if(var_377 != null)
         {
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_154 && _loc5_ != RoomObjectVisualizationEnum.const_103)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_420.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_274 + param1) == RoomObjectCategoryEnum.const_60)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1140.getValue(param1) != null)
         {
            var_165 = var_1140.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_165 != null)
         {
            return var_165.getWorldScale(const_274 + param1);
         }
         return 32;
      }
