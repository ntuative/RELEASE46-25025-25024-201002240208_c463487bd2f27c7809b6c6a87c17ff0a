package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_781:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1108:String = "tile_cursor";
      ...
      private var var_602:NumberBank;
      ...
      private var var_715:RoomMessageHandler = null;
      
      private var var_714:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_305 = new Map();
         var_602 = new NumberBank(1000);
         var_1052 = new Map();
         var_306 = new Map();
         var_66 = new RoomObjectEventHandler(this);
         var_715 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_66 != null)
         {
            ...
            {
               return var_66.deleteWallItem(var_115,var_114,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_566) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_668) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_655) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_543) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_136);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_66 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_28)
            {
               return var_66.modifyWallItemData(var_115,var_114,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_420 != null)
         {
            var_420.release(new IIDRoomObjectVisualizationFactory());
            var_420 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_714 != null)
         {
            var_714.release(new IIDRoomRendererFactory());
            var_714 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_714.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_829;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_520);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_661);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_594);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_953);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1005);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_963) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_982);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_418,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_517,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_531,var_115,var_114,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_66 != null)
         {
            return var_66.modifyRoomObject(var_115,var_114,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_643,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_513,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_586,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_31);
            ...
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_260);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_66 != null)
         {
            var_66.handleRoomObjectEvent(param1,var_115,var_114);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_294,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1008,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_998,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_937,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_239,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_542,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_25 == null || var_420 == null || var_41 == null || var_714 == null || _communication == null || var_97 == null || !var_2132)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_115,var_114));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_779,RoomObjectCategoryEnum.const_260);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_114,var_1308);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_114,var_1308);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_420;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_25 != null)
         {
            if(false)
            {
               var_25.events.addEventListener(RoomObjectMouseEvent.const_211,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_473,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_457,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_258,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_580,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_117,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_107,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_109,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_120,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_108,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_88,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_410,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_365,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_449,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_414,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_374,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_402,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_353,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_396,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_360,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.DIMMER_STATE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_363,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_456,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_266,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_416,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_317,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_300,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_462,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_933,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_376,roomObjectEventHandler);
               var_25.events.addEventListener(AvatarWalkWarpingWarningEvent.const_469,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_115,var_114);
         ...
         if(var_66 != null)
         {
            return var_66.initializeRoomObjectInsert(var_115,var_114,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_239,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_378);
                     break;
                  case RoomObjectCategoryEnum.const_33:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_153);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_293);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_656)
         {
            var_2132 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_294,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_829,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_239,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_431,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_781) as Sprite;
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_714 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_504 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_41.getRoom(const_495);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_495,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_602.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_378,param8);
               break;
            case RoomObjectCategoryEnum.const_33:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_153,param2);
               break;
            case RoomObjectCategoryEnum.const_60:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_140,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_142,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_142,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_242,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_538,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_555,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_735,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_418,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1052.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_964,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_602.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_780,RoomObjectCategoryEnum.const_260);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_114,param1);
         if(_loc9_ != null)
         {
            var_1308 = param1;
            var_1551 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1551 - _loc12_.width / 2;
               _loc11_.y = var_1550 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_384,var_115,var_114,-1,RoomObjectCategoryEnum.const_202));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_66 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_276,const_494);
                  var_66.handleRoomObjectEvent(_loc14_,var_115,var_114);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_115,var_114,param1,param2,new Vector3d(),1,null);
         }
         else if(var_9 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_114,var_1308);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1551 - _loc6_.data.width / 2;
               _loc11_.y = var_1550 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_286,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_843,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_883,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_995,RoomObjectVariableEnum.const_286,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_9 != null)
         {
            _events.addEventListener(RoomContentLoader.const_656,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_66 != null)
         {
            var_66.cancelRoomObjectInsert(var_115,var_114);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_495);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_964);
               ...
               var_602.freeNumber(_loc10_ - 1);
               _loc13_ = var_1052.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_115,var_114,const_276,RoomObjectCategoryEnum.const_60,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_276,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_926,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_595,1,true);
            _loc13_ = parseInt(var_97.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_984,_loc13_,true);
            if(var_9 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_276,const_494,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_595,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_520,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_566,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_655,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_668,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_543,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_869,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_643,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_513,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_586,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_418,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_199);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_661,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_594,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_661,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_594,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_953,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1005,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_780,const_1108,RoomObjectCategoryEnum.const_260);
         _loc7_.createRoomObject(const_779,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_260);
         return _loc7_;
      }
