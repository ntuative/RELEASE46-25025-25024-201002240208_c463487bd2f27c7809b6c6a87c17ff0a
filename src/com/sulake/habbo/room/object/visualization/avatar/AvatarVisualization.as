package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1410:int = 0;
      
      private var var_530:String;
      
      private var var_617:int = 0;
      
      private const const_1626:int = 1;
      ...
      private const const_1095:int = 3;
      
      private const const_1625:int = 2;
      
      private var var_867:AvatarVisualizationData = null;
      ...
      {
         var_867 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_428.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_153);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_697);
         ...
         var _loc14_:Number = _loc8_ - var_1282;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_320);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_281 != _loc3_.getUpdateID() || var_206 != param1.scale || var_160 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_487 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_487;
            ...
            if(var_530 != _loc7_)
            {
               for each(_loc49_ in var_428.getKeys())
               {
                  var_428.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_867.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_428.remove(_loc5_);
               var_428.add(_loc5_,_loc6_);
               var_530 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_293);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_238) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_238);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_733);
            _loc6_.appendAction(AvatarAction.const_500,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_355);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_50)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_435);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_310,AvatarAction.const_1328[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_914);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_834,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_801);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_819);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_940,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_567);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_509);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_787,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_897);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_958,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_367);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_471) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_705);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_389);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_846);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_650,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1625);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_945))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_867.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_868.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_868)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_428 != null)
         {
            _loc1_ = var_428.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_428.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
