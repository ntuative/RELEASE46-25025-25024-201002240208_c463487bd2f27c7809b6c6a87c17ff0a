package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_970:LayoutRasterizerData = null;
      ...
      {
         var_457 = true;
         var _loc3_:int = var_324.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_324.push(param1);
            var_456.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_969 = param1;
         var _loc3_:LayoutRasterizerData = var_62.getValue(var_647);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1156 = RoomObjectVariableEnum.const_843;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1156 = RoomObjectVariableEnum.const_883;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_969 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_969 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_969 + _adBgIndex);
            _loc5_ = param1.getSprite(var_969 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1156);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_468;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1764);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_647)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_970 = var_62.getValue(var_647);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_62.getValue(var_647);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_970.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_324.indexOf(_loc10_) >= 0 && var_457)
            {
               param1 = var_324.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_456[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_458[param1];
               }
               var_324.splice(param1,1);
               var_456.splice(param1,1);
               var_458.splice(param1,1);
               if(false)
               {
                  var_457 = false;
               }
