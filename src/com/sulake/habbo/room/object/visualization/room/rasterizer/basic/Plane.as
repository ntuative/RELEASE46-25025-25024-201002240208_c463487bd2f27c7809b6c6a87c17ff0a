package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_739:PlaneVisualization = null;
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_739 = var_429.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_739 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_429 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_429.length)
            {
               _loc1_ = var_429.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
