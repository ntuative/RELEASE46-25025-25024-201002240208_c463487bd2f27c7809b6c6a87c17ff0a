package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_664:IPlaneRasterizer = null;
      ...
      private var var_571:PlaneMaskManager = null;
      ...
      private var var_167:BitmapData = null;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_255 || _type == const_177))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_806 || false && false && !var_151 || var_571 == null)
         {
            return;
         }
         ...
         if(var_151)
         {
            ...
            while(_loc5_ < var_191.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_571.updateMask(var_57,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_663.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_255.length)
            {
               _loc4_ = var_255[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_664 != null)
         {
            return var_664.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_255 || _type == const_177)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_191.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_663.length)
                  {
                     _loc7_ = var_663[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1162.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1162[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(var_806)
         {
            ...
            while(_loc6_ < var_255.length)
            {
               _loc5_ = var_255[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_664 != null)
            {
               _loc3_ = var_664.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1431,var_1853,var_1850,var_1854,var_1851,param2);
               if(_loc3_ != null)
               {
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(var_167 != null && (var_167.width != param1.width || var_167.height != param1.height))
         {
            var_167.dispose();
            var_167 = null;
         }
         if(var_167 == null)
         {
            var_167 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         var_167.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         var_167.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(var_167,var_167.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
