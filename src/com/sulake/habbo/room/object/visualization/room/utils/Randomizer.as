package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1523:int = 16777216;
      
      public static const const_1472:int = 1;
       
      
      private var var_2339:int = 69069;
      
      private var var_1259:int = 1;
      
      private var var_2338:int = 5;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1491 * param2);
      }
      ...
      {
         var _loc1_:int = var_2339 * var_1259 + var_2338;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
