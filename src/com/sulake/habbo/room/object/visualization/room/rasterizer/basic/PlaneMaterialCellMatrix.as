package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1261:int = const_280;
      
      public static const const_214:int = 2;
      
      public static const const_197:int = 3;
      ...
      public static const const_724:int = 6;
      
      public static const const_229:int = const_101;
      ...
      private var var_759:Vector3d = null;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1785 = param6;
         var_1787 = param7;
         var_759 = new Vector3d();
         if(var_1518 == const_724)
         {
            var_1324 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1561 == const_101)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_510);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_510,var_26.width,var_510);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_759,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_510,param6,param7);
                     return param1;
                  }
                  return var_26;
               }
