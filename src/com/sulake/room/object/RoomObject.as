package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private static var var_1192:int = 0;
      ...
      public function RoomObject(param1:int, param2:int)
      {
         ...
         var_1478 = new Vector3d();
         var_477 = new Array(param2);
      ...
      {
         var_1478.assign(var_223);
         return var_1478;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_477.length)
         {
            if(var_477[param2] != param1)
            {
               var_477[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      {
         if(param1 >= 0 && param1 < var_477.length)
         {
