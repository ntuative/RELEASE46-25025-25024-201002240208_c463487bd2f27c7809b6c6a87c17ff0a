package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_783:int = 50;
      ...
      private var var_2168:Number = -10000000;
      
      private var var_2167:Number = -10000000;
      
      private var var_2341:int = 0;
      
      private var var_509:RoomObjectCache;
      ...
      public function update() : void
      {
         if(var_1062 == 0)
         {
            checkMouseHits(var_1063.x,var_1063.y,MouseEvent.MOUSE_MOVE);
         }
         var_1062 = 0;
         ++var_1560;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_277 != null)
         {
            var_277.graphics.clear();
         }
         else
         {
            var_277 = new Sprite();
            var_277.name = "mask";
            _master.addChild(var_277);
         }
         var_277.graphics.beginFill(0);
         var_277.graphics.drawRect(0,0,param1,param2);
         var_720 = param1;
         var_719 = param2;
      ...
      {
         var _loc11_:Number = param1 - var_720 / 2;
         var _loc12_:Number = param2 - var_719 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_720 != var_2164 || var_719 != var_2165)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_423.sortOn("z",0 | 0);
         if(_loc6_ < var_423.length)
         {
            var_423.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_423[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_721.push(_loc12_ - _loc2_);
         if(var_721.length == const_783)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_783)
            {
               _loc13_ += var_721[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_508 != null)
         {
            ...
            {
               cleanSprite(var_508[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_508 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_310 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_310.getKey(_loc1_);
            _loc3_ = var_310.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1064 != null)
                  {
                     var_1064.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1560,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_423.length)
         {
            return null;
         }
         return var_423[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_507.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_507.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2168 || param2 != var_2167)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_507.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_507.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_508.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_509.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_509.getObjectCache(param2);
         ...
         _loc12_ += int(var_720 / 2);
         _loc13_ += int(var_719 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_720 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_719))
                  {
