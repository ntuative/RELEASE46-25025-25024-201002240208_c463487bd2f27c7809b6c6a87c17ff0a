package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_646:Number = 64;
      
      public static const const_997:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_85 = new Vector3d();
         var_1000 = new Vector3d();
         var_1442 = 1;
         var_1443 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1441 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_390 != param1 * var_1441)
         {
            var_390 = param1 * var_1441;
            ++var_77;
         }
      }
      ...
      {
         if(var_387 != param1 * var_1442)
         {
            var_387 = param1 * var_1442;
            ++var_77;
         }
      }
      ...
      {
         if(var_388 != param1 * var_1443)
         {
            var_388 = param1 * var_1443;
            ++var_77;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_389 != null)
         {
            ...
            var_389.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_389.add(_loc3_,_loc4_);
            ++var_77;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1000.assign(_loc22_);
         }
         else
         {
            var_1000.assign(_loc17_);
         }
         ++var_77;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_388;
         _loc2_.z *= var_390;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1000);
         if(_loc3_ < var_2334 || _loc3_ > var_2335)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_388;
            _loc2_.z *= var_390;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1000);
         }
      ...
      {
         return new Vector3d(0 * var_387,0 * var_388,0 * var_390);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_389 != null)
         {
            ...
            return var_389.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_387,0 * var_388,0 * var_390);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_85;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_387,param2.y * var_388,param2.z * var_390);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_387,param3.y * var_388,param3.z * var_390);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_387,param4.y * var_388,param4.z * var_390);
